    ...
    module Europe
      module Vilnius
        ...
        timezone 'Europe/Vilnius' do |tz|
          ...
          tz.transition 2064, 3, :o8, 59400229, 24
          tz.transition 2064, 10, :o4, 59405269, 24
          tz.transition 2065, 3, :o8, 59408965, 24
          tz.transition 2065, 10, :o4, 59414005, 24
          tz.transition 2066, 3, :o8, 59417701, 24
          tz.transition 2066, 10, :o4, 59422909, 24
          tz.transition 2067, 3, :o8, 59426437, 24
          tz.transition 2067, 10, :o4, 59431645, 24
          tz.transition 2068, 3, :o8, 59435173, 24
          tz.transition 2068, 10, :o4, 59440381, 24
          tz.transition 2069, 3, :o8, 59444077, 24
          tz.transition 2069, 10, :o4, 59449117, 24
          tz.transition 2070, 3, :o8, 59452813, 24
          tz.transition 2070, 10, :o4, 59457853, 24
          tz.transition 2071, 3, :o8, 59461549, 24
          tz.transition 2071, 10, :o4, 59466589, 24
          tz.transition 2072, 3, :o8, 59470285, 24
          tz.transition 2072, 10, :o4, 59475493, 24
          tz.transition 2073, 3, :o8, 59479021, 24
          tz.transition 2073, 10, :o4, 59484229, 24
          tz.transition 2074, 3, :o8, 59487757, 24
          tz.transition 2074, 10, :o4, 59492965, 24
          tz.transition 2075, 3, :o8, 59496661, 24
          tz.transition 2075, 10, :o4, 59501701, 24
          tz.transition 2076, 3, :o8, 59505397, 24
