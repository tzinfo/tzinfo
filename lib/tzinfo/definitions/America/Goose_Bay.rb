    ...
    module America
      module Goose_Bay
        ...
        timezone 'America/Goose_Bay' do |tz|
          ...
          tz.transition 2064, 3, :o8, 9899955, 4
          tz.transition 2064, 11, :o7, 59405441, 24
          tz.transition 2065, 3, :o8, 9901411, 4
          tz.transition 2065, 11, :o7, 59414177, 24
          tz.transition 2066, 3, :o8, 9902895, 4
          tz.transition 2066, 11, :o7, 59423081, 24
          tz.transition 2067, 3, :o8, 9904351, 4
          tz.transition 2067, 11, :o7, 59431817, 24
          tz.transition 2068, 3, :o8, 9905807, 4
          tz.transition 2068, 11, :o7, 59440553, 24
          tz.transition 2069, 3, :o8, 9907263, 4
          tz.transition 2069, 11, :o7, 59449289, 24
          tz.transition 2070, 3, :o8, 9908719, 4
          tz.transition 2070, 11, :o7, 59458025, 24
          tz.transition 2071, 3, :o8, 9910175, 4
          tz.transition 2071, 11, :o7, 59466761, 24
          tz.transition 2072, 3, :o8, 9911659, 4
          tz.transition 2072, 11, :o7, 59475665, 24
          tz.transition 2073, 3, :o8, 9913115, 4
          tz.transition 2073, 11, :o7, 59484401, 24
          tz.transition 2074, 3, :o8, 9914571, 4
          tz.transition 2074, 11, :o7, 59493137, 24
          tz.transition 2075, 3, :o8, 9916027, 4
          tz.transition 2075, 11, :o7, 59501873, 24
          tz.transition 2076, 3, :o8, 9917483, 4
          tz.transition 2076, 11, :o7, 59510609, 24
        end
      end
    end
  end
