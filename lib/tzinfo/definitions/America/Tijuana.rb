    ...
    module America
      module Tijuana
        ...
        timezone 'America/Tijuana' do |tz|
          ...
          tz.transition 1953, 4, :o3, 19475951, 8
          tz.transition 1953, 9, :o2, 19477183, 8
          ...
          tz.transition 1961, 4, :o3, 19499359, 8
          tz.transition 1961, 9, :o2, 19500535, 8
          tz.transition 1962, 4, :o3, 19502271, 8
          tz.transition 1962, 10, :o2, 19503727, 8
          tz.transition 1963, 4, :o3, 19505183, 8
          tz.transition 1963, 10, :o2, 19506639, 8
          tz.transition 1964, 4, :o3, 19508095, 8
          tz.transition 1964, 10, :o2, 19509551, 8
          tz.transition 1965, 4, :o3, 19511007, 8
          tz.transition 1965, 10, :o2, 19512519, 8
          tz.transition 1966, 4, :o3, 19513919, 8
          tz.transition 1966, 10, :o2, 19515431, 8
          tz.transition 1967, 4, :o3, 29275331, 12
          tz.transition 1967, 10, :o2, 19518343, 8
          tz.transition 1968, 4, :o3, 29279699, 12
          tz.transition 1968, 10, :o2, 19521255, 8
          tz.transition 1969, 4, :o3, 29284067, 12
          ...
          tz.transition 2064, 3, :o3, 29699867, 12
          tz.transition 2064, 11, :o2, 19801815, 8
          tz.transition 2065, 3, :o3, 29704235, 12
          tz.transition 2065, 11, :o2, 19804727, 8
          tz.transition 2066, 3, :o3, 29708687, 12
          tz.transition 2066, 11, :o2, 19807695, 8
          tz.transition 2067, 3, :o3, 29713055, 12
          tz.transition 2067, 11, :o2, 19810607, 8
          tz.transition 2068, 3, :o3, 29717423, 12
          tz.transition 2068, 11, :o2, 19813519, 8
          tz.transition 2069, 3, :o3, 29721791, 12
          tz.transition 2069, 11, :o2, 19816431, 8
          tz.transition 2070, 3, :o3, 29726159, 12
          tz.transition 2070, 11, :o2, 19819343, 8
          tz.transition 2071, 3, :o3, 29730527, 12
          tz.transition 2071, 11, :o2, 19822255, 8
          tz.transition 2072, 3, :o3, 29734979, 12
          tz.transition 2072, 11, :o2, 19825223, 8
          tz.transition 2073, 3, :o3, 29739347, 12
          tz.transition 2073, 11, :o2, 19828135, 8
          tz.transition 2074, 3, :o3, 29743715, 12
          tz.transition 2074, 11, :o2, 19831047, 8
          tz.transition 2075, 3, :o3, 29748083, 12
          tz.transition 2075, 11, :o2, 19833959, 8
          tz.transition 2076, 3, :o3, 29752451, 12
          tz.transition 2076, 11, :o2, 19836871, 8
        end
      end
    end
  end
