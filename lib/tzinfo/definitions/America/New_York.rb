    ...
    module America
      module New_York
        ...
        timezone 'America/New_York' do |tz|
          ...
          tz.transition 2064, 3, :o2, 59399731, 24
          tz.transition 2064, 11, :o1, 9900907, 4
          tz.transition 2065, 3, :o2, 59408467, 24
          tz.transition 2065, 11, :o1, 9902363, 4
          tz.transition 2066, 3, :o2, 59417371, 24
          tz.transition 2066, 11, :o1, 9903847, 4
          tz.transition 2067, 3, :o2, 59426107, 24
          tz.transition 2067, 11, :o1, 9905303, 4
          tz.transition 2068, 3, :o2, 59434843, 24
          tz.transition 2068, 11, :o1, 9906759, 4
          tz.transition 2069, 3, :o2, 59443579, 24
          tz.transition 2069, 11, :o1, 9908215, 4
          tz.transition 2070, 3, :o2, 59452315, 24
          tz.transition 2070, 11, :o1, 9909671, 4
          tz.transition 2071, 3, :o2, 59461051, 24
          tz.transition 2071, 11, :o1, 9911127, 4
          tz.transition 2072, 3, :o2, 59469955, 24
          tz.transition 2072, 11, :o1, 9912611, 4
          tz.transition 2073, 3, :o2, 59478691, 24
          tz.transition 2073, 11, :o1, 9914067, 4
          tz.transition 2074, 3, :o2, 59487427, 24
          tz.transition 2074, 11, :o1, 9915523, 4
          tz.transition 2075, 3, :o2, 59496163, 24
          tz.transition 2075, 11, :o1, 9916979, 4
          tz.transition 2076, 3, :o2, 59504899, 24
          tz.transition 2076, 11, :o1, 9918435, 4
        end
      end
    end
  end
