    ...
    module America
      module Nassau
        ...
        timezone 'America/Nassau' do |tz|
          ...
          tz.transition 1942, 5, :o2, 58331561, 24
          tz.transition 1945, 1, :o1, 7294370, 3
          tz.transition 1945, 2, :o2, 58355705, 24
          tz.transition 1945, 8, :o3, 58360379, 24
          tz.transition 1945, 10, :o1, 7295240, 3
          tz.transition 1964, 4, :o4, 58524283, 24
          tz.transition 1964, 10, :o1, 9754775, 4
          tz.transition 1965, 4, :o4, 58533019, 24
          tz.transition 1965, 10, :o1, 9756259, 4
          tz.transition 1966, 4, :o4, 58541755, 24
          tz.transition 1966, 10, :o1, 9757715, 4
          tz.transition 1967, 4, :o4, 58550659, 24
          tz.transition 1967, 10, :o1, 9759171, 4
          tz.transition 1968, 4, :o4, 58559395, 24
          tz.transition 1968, 10, :o1, 9760627, 4
          tz.transition 1969, 4, :o4, 58568131, 24
