  ...
  module Definitions
    module America
      module Coyhaique
        ...
        timezone 'America/Coyhaique' do |tz|
          tz.offset :o0, -17296, 0, :LMT
          ...
          tz.transition 1890, 1, :o1, 13021390981, 5400
          ...
          tz.transition 1946, 8, :o4, 7296185, 3
          ...
          tz.transition 2025, 3, :o6, 1742439600
        end
      end
    end
  end
