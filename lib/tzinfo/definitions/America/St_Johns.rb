    ...
    module America
      module St_Johns
        ...
        timezone 'America/St_Johns' do |tz|
          ...
          tz.transition 2064, 3, :o4, 118799459, 48
          tz.transition 2064, 11, :o3, 39603627, 16
          tz.transition 2065, 3, :o4, 118816931, 48
          tz.transition 2065, 11, :o3, 39609451, 16
          tz.transition 2066, 3, :o4, 118834739, 48
          tz.transition 2066, 11, :o3, 39615387, 16
          tz.transition 2067, 3, :o4, 118852211, 48
          tz.transition 2067, 11, :o3, 39621211, 16
          tz.transition 2068, 3, :o4, 118869683, 48
          tz.transition 2068, 11, :o3, 39627035, 16
          tz.transition 2069, 3, :o4, 118887155, 48
          tz.transition 2069, 11, :o3, 39632859, 16
          tz.transition 2070, 3, :o4, 118904627, 48
          tz.transition 2070, 11, :o3, 39638683, 16
          tz.transition 2071, 3, :o4, 118922099, 48
          tz.transition 2071, 11, :o3, 39644507, 16
          tz.transition 2072, 3, :o4, 118939907, 48
          tz.transition 2072, 11, :o3, 39650443, 16
          tz.transition 2073, 3, :o4, 118957379, 48
          tz.transition 2073, 11, :o3, 39656267, 16
          tz.transition 2074, 3, :o4, 118974851, 48
          tz.transition 2074, 11, :o3, 39662091, 16
          tz.transition 2075, 3, :o4, 118992323, 48
          tz.transition 2075, 11, :o3, 39667915, 16
          tz.transition 2076, 3, :o4, 119009795, 48
          tz.transition 2076, 11, :o3, 39673739, 16
        end
      end
    end
  end
