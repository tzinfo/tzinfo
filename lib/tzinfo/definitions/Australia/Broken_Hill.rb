    ...
    module Australia
      module Broken_Hill
        ...
        timezone 'Australia/Broken_Hill' do |tz|
          ...
          tz.transition 1916, 12, :o4, 38739667, 16
          tz.transition 1917, 3, :o3, 38740995, 16
          tz.transition 1941, 12, :o4, 38885763, 16
          tz.transition 1942, 3, :o3, 38887155, 16
          tz.transition 1942, 9, :o4, 38890067, 16
          tz.transition 1943, 3, :o3, 38892979, 16
          tz.transition 1943, 10, :o4, 38896003, 16
          tz.transition 1944, 3, :o3, 38898803, 16
          ...
          tz.transition 2063, 10, :o4, 39597347, 16
          tz.transition 2064, 4, :o3, 39600259, 16
          tz.transition 2064, 10, :o4, 39603171, 16
          tz.transition 2065, 4, :o3, 39606083, 16
          tz.transition 2065, 10, :o4, 39608995, 16
          tz.transition 2066, 4, :o3, 39611907, 16
          tz.transition 2066, 10, :o4, 39614819, 16
          tz.transition 2067, 4, :o3, 39617731, 16
          tz.transition 2067, 10, :o4, 39620643, 16
          tz.transition 2068, 3, :o3, 39623555, 16
          tz.transition 2068, 10, :o4, 39626579, 16
          tz.transition 2069, 4, :o3, 39629491, 16
          tz.transition 2069, 10, :o4, 39632403, 16
          tz.transition 2070, 4, :o3, 39635315, 16
          tz.transition 2070, 10, :o4, 39638227, 16
          tz.transition 2071, 4, :o3, 39641139, 16
          tz.transition 2071, 10, :o4, 39644051, 16
          tz.transition 2072, 4, :o3, 39646963, 16
          tz.transition 2072, 10, :o4, 39649875, 16
          tz.transition 2073, 4, :o3, 39652787, 16
          tz.transition 2073, 9, :o4, 39655699, 16
          tz.transition 2074, 3, :o3, 39658611, 16
          tz.transition 2074, 10, :o4, 39661635, 16
          tz.transition 2075, 4, :o3, 39664547, 16
          tz.transition 2075, 10, :o4, 39667459, 16
          tz.transition 2076, 4, :o3, 39670371, 16
        end
      end
    end
  end
