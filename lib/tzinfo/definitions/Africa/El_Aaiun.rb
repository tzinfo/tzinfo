    ...
    module Africa
      module El_Aaiun
        ...
        timezone 'Africa/El_Aaiun' do |tz|
          ...
          tz.transition 2038, 9, :o5, 29588311, 12
          tz.transition 2038, 10, :o4, 29588731, 12
          tz.transition 2039, 9, :o5, 29592595, 12
          tz.transition 2039, 10, :o4, 29593015, 12
          tz.transition 2040, 9, :o5, 29596795, 12
          tz.transition 2040, 10, :o4, 29597299, 12
          tz.transition 2041, 8, :o5, 29601079, 12
          tz.transition 2041, 9, :o4, 29601499, 12
          tz.transition 2042, 8, :o5, 29605279, 12
          tz.transition 2042, 9, :o4, 29605783, 12
          tz.transition 2043, 8, :o5, 29609563, 12
          tz.transition 2043, 9, :o4, 29610067, 12
          tz.transition 2044, 7, :o5, 29613847, 12
          tz.transition 2044, 8, :o4, 29614267, 12
          tz.transition 2045, 7, :o5, 29618047, 12
          tz.transition 2045, 8, :o4, 29618551, 12
          tz.transition 2046, 7, :o5, 29622331, 12
          tz.transition 2046, 8, :o4, 29622751, 12
          tz.transition 2047, 6, :o5, 29626615, 12
          tz.transition 2047, 7, :o4, 29627035, 12
          tz.transition 2048, 6, :o5, 29630815, 12
          tz.transition 2048, 7, :o4, 29631319, 12
          tz.transition 2049, 5, :o5, 29635099, 12
          tz.transition 2049, 7, :o4, 29635519, 12
          tz.transition 2050, 5, :o5, 29639299, 12
          tz.transition 2050, 6, :o4, 29639803, 12
          tz.transition 2051, 5, :o5, 29643583, 12
          tz.transition 2051, 6, :o4, 29644087, 12
          tz.transition 2052, 4, :o5, 29647867, 12
          tz.transition 2052, 6, :o4, 29648287, 12
          tz.transition 2053, 4, :o5, 29652067, 12
          tz.transition 2053, 5, :o4, 29652571, 12
          tz.transition 2054, 4, :o5, 29656351, 12
          tz.transition 2054, 5, :o4, 29656771, 12
          tz.transition 2055, 3, :o5, 29660635, 12
          tz.transition 2055, 5, :o4, 29661055, 12
          tz.transition 2056, 3, :o5, 29664835, 12
          tz.transition 2056, 4, :o4, 29665339, 12
          tz.transition 2057, 3, :o5, 29669119, 12
          tz.transition 2057, 4, :o4, 29669539, 12
          tz.transition 2058, 2, :o5, 29673319, 12
          tz.transition 2058, 3, :o4, 29673823, 12
          tz.transition 2059, 2, :o5, 29677603, 12
          tz.transition 2059, 3, :o4, 29678107, 12
          tz.transition 2060, 2, :o5, 29681887, 12
          tz.transition 2060, 3, :o4, 29682307, 12
          tz.transition 2061, 1, :o5, 29686087, 12
          tz.transition 2061, 2, :o4, 29686591, 12
          tz.transition 2062, 1, :o5, 29690371, 12
          tz.transition 2062, 2, :o4, 29690791, 12
          tz.transition 2062, 12, :o5, 29694655, 12
          tz.transition 2063, 2, :o4, 29695075, 12
          tz.transition 2063, 12, :o5, 29698855, 12
          tz.transition 2064, 1, :o4, 29699359, 12
          tz.transition 2064, 12, :o5, 29703139, 12
          tz.transition 2065, 1, :o4, 29703559, 12
          tz.transition 2065, 11, :o5, 29707339, 12
          tz.transition 2066, 1, :o4, 29707843, 12
          tz.transition 2066, 11, :o5, 29711623, 12
          tz.transition 2066, 12, :o4, 29712127, 12
          tz.transition 2067, 11, :o5, 29715907, 12
          tz.transition 2067, 12, :o4, 29716327, 12
          tz.transition 2068, 10, :o5, 29720107, 12
          tz.transition 2068, 12, :o4, 29720611, 12
          tz.transition 2069, 10, :o5, 29724391, 12
          tz.transition 2069, 11, :o4, 29724811, 12
          tz.transition 2070, 10, :o5, 29728675, 12
          tz.transition 2070, 11, :o4, 29729095, 12
          tz.transition 2071, 9, :o5, 29732875, 12
          tz.transition 2071, 11, :o4, 29733379, 12
          tz.transition 2072, 9, :o5, 29737159, 12
          tz.transition 2072, 10, :o4, 29737579, 12
          tz.transition 2073, 8, :o5, 29741359, 12
          tz.transition 2073, 10, :o4, 29741863, 12
          tz.transition 2074, 8, :o5, 29745643, 12
          tz.transition 2074, 9, :o4, 29746147, 12
          tz.transition 2075, 8, :o5, 29749927, 12
          tz.transition 2075, 9, :o4, 29750347, 12
          tz.transition 2076, 7, :o5, 29754127, 12
          tz.transition 2076, 9, :o4, 29754631, 12
        end
      end
    end
  end
