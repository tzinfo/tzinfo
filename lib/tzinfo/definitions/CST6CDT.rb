  ...
  module Definitions
    module CST6CDT
      ...
      timezone 'CST6CDT' do |tz|
        ...
        tz.transition 1942, 2, :o1, 14582399, 6
        ...
        tz.transition 2074, 3, :o1, 14871857, 6
        tz.transition 2074, 11, :o0, 59493139, 24
        tz.transition 2075, 3, :o1, 14874041, 6
        tz.transition 2075, 11, :o0, 59501875, 24
        tz.transition 2076, 3, :o1, 14876225, 6
        tz.transition 2076, 11, :o0, 59510611, 24
      end
    end
  end
end
