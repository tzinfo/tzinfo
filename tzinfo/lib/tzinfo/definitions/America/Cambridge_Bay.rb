...
add_period(TimezonePeriod.new(nil,DateTime.new(1884,1,1,7,0,20),-25220,0,'LMT'))
add_period(TimezonePeriod.new(DateTime.new(1884,1,1,7,0,20),DateTime.new(1918,4,14,9,0,0),-25200,0,'MT'))
...
add_period(TimezonePeriod.new(DateTime.new(2000,10,29,7,0,0),DateTime.new(2000,11,5,5,0,0),-18000,0,'EST'))
add_period(TimezonePeriod.new(DateTime.new(2000,11,5,5,0,0),DateTime.new(2001,4,1,9,0,0),-21600,0,'CST'))
...
add_period(TimezonePeriod.new(DateTime.new(2045,4,2,9,0,0),DateTime.new(2045,8,19,20,37,35),-25200,3600,'MDT'))
end
@@instance = new
def self.instance
   @@instance
