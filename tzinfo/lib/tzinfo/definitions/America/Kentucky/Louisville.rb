...
add_period(1921,1) {TimezonePeriod.new(DateTime.new0(Rational.new!(9690763,4),0,Date::ITALY),DateTime.new0(Rational.new!(14536865,6),0,Date::ITALY),-21600,0,:'CST')}
...
add_period(1968,1) {TimezonePeriod.new(DateTime.new0(Rational.new!(58556561,24),0,Date::ITALY),DateTime.new0(Rational.new!(58559395,24),0,Date::ITALY),-18000,0,:'EST')}
