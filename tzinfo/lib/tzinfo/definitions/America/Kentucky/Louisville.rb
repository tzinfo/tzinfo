...
add_period(1919,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(58134187,24),0,Date::ITALY),DateTime.new0(Rational.new!(14536865,6),0,Date::ITALY),-21600,0,:CST)}
...
add_period(1946,1) {TimezonePeriod.new(DateTime.new0(Rational.new!(9727287,4),0,Date::ITALY),DateTime.new0(Rational.new!(58367371,24),0,Date::ITALY),-21600,3600,:CDT)}
...
add_period(1961,7) {TimezonePeriod.new(DateTime.new0(Rational.new!(58500091,24),0,Date::ITALY),DateTime.new0(Rational.new!(58559395,24),0,Date::ITALY),-18000,0,:EST)}
