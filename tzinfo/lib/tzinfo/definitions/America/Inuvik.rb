...
add_period(TimezonePeriod.new(nil,DateTime.new(1884,1,1,8,54,0),-32040,0,'LMT'))
add_period(TimezonePeriod.new(DateTime.new(1884,1,1,8,54,0),DateTime.new(1918,4,14,10,0,0),-28800,0,'PT'))
add_period(TimezonePeriod.new(DateTime.new(1918,4,14,10,0,0),DateTime.new(1918,10,27,9,0,0),-28800,3600,'PDT'))
add_period(TimezonePeriod.new(DateTime.new(1918,10,27,9,0,0),DateTime.new(1919,5,25,10,0,0),-28800,0,'PST'))
add_period(TimezonePeriod.new(DateTime.new(1919,5,25,10,0,0),DateTime.new(1919,11,1,7,0,0),-28800,3600,'PDT'))
add_period(TimezonePeriod.new(DateTime.new(1919,11,1,7,0,0),DateTime.new(1942,2,9,10,0,0),-28800,0,'PST'))
add_period(TimezonePeriod.new(DateTime.new(1942,2,9,10,0,0),DateTime.new(1945,9,30,9,0,0),-28800,3600,'PWT'))
add_period(TimezonePeriod.new(DateTime.new(1945,9,30,9,0,0),DateTime.new(1965,4,25,8,0,0),-28800,0,'PST'))
add_period(TimezonePeriod.new(DateTime.new(1965,4,25,8,0,0),DateTime.new(1965,10,31,8,0,0),-28800,7200,'PDDT'))
add_period(TimezonePeriod.new(DateTime.new(1965,10,31,8,0,0),DateTime.new(1979,4,29,10,0,0),-28800,0,'PST'))
add_period(TimezonePeriod.new(DateTime.new(1979,4,29,10,0,0),DateTime.new(1980,4,27,9,0,0),-25200,0,'MT'))
...
add_period(TimezonePeriod.new(DateTime.new(2045,4,2,9,0,0),DateTime.new(2045,8,19,20,39,25),-25200,3600,'MDT'))
end
@@instance = new
def self.instance
   @@instance
