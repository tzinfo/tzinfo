...
add_period(1965,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(14634389,6),0,Date::ITALY),DateTime.new0(Rational.new!(29327915,12),0,Date::ITALY),-28800,0,:'PST')}
add_period(1979,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(29327915,12),0,Date::ITALY),DateTime.new0(Rational.new!(19554855,8),0,Date::ITALY),-25200,0,:'MT')}
