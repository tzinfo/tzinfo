...
add_period(TimezonePeriod.new(nil,DateTime.new(1922,1,1,7,0,0),-25460,0,'LMT'))
...
add_period(TimezonePeriod.new(DateTime.new(1932,4,1,7,0,0),DateTime.new(1996,1,1,6,0,0),-21600,0,'CST'))
add_period(TimezonePeriod.new(DateTime.new(1996,1,1,6,0,0),DateTime.new(1996,4,7,8,0,0),-21600,0,'CT'))
...
add_period(TimezonePeriod.new(DateTime.new(1997,10,26,7,0,0),DateTime.new(1998,1,1,6,0,0),-21600,0,'CST'))
add_period(TimezonePeriod.new(DateTime.new(1998,1,1,6,0,0),DateTime.new(1998,4,5,9,0,0),-21600,0,'CST'))
...
add_period(TimezonePeriod.new(DateTime.new(2045,4,2,9,0,0),DateTime.new(2045,8,19,20,50,17),-25200,3600,'MDT'))
end
@@instance = new
def self.instance
   @@instance
