...
add_period(1900,8) {TimezonePeriod.new(DateTime.new0(Rational.new!(41735561267,17280),0,Date::ITALY),DateTime.new0(Rational.new!(58329599,24),0,Date::ITALY),-32400,0,:YST)}
...
add_period(1945,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(29180747,12),0,Date::ITALY),DateTime.new0(Rational.new!(58568135,24),0,Date::ITALY),-32400,0,:YST)}
