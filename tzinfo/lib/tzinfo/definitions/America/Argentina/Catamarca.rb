...
add_period(TimezonePeriod.new(nil,DateTime.new(1894,10,31,4,23,8),-15788,0,'LMT'))
add_period(TimezonePeriod.new(DateTime.new(1894,10,31,4,23,8),DateTime.new(1920,5,1,4,16,48),-15408,0,'CMT'))
...
add_period(TimezonePeriod.new(DateTime.new(1991,3,3,2,0,0),DateTime.new(1991,10,20,4,0,0),-14400,0,'WART'))
add_period(TimezonePeriod.new(DateTime.new(1991,10,20,4,0,0),DateTime.new(1992,3,1,2,0,0),-10800,3600,'ARST'))
