...
class Catamarca < Timezone #:nodoc:
setup
set_identifier('America/Argentina/Catamarca')
add_unbounded_start_period {TimezonePeriod.new(nil,DateTime.new0(Rational.new!(52123665947,21600),0,Date::ITALY),-15788,0,:'LMT')}
add_period(1894,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(52123665947,21600),0,Date::ITALY),DateTime.new0(Rational.new!(1453467407,600),0,Date::ITALY),-15408,0,:'CMT')}
...
add_period(1990,10) {TimezonePeriod.new(656478000,667965600,-10800,3600,:'ARST')}
add_period(1991,3) {TimezonePeriod.new(667965600,687931200,-14400,0,:'WART')}
add_period(1991,10) {TimezonePeriod.new(687931200,699415200,-10800,3600,:'ARST')}
...
add_period(2000,3) {TimezonePeriod.new(952056000,1086058800,-10800,0,:'ART')}
add_period(2004,6) {TimezonePeriod.new(1086058800,1087704000,-14400,0,:'WART')}
add_period(2004,6) {TimezonePeriod.new(1087704000,nil,-10800,0,:'ART')}
end
end
end
end
