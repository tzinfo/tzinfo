...
add_period(TimezonePeriod.new(nil,DateTime.new(1894,10,31,4,27,24),-16044,0,'LMT'))
add_period(TimezonePeriod.new(DateTime.new(1894,10,31,4,27,24),DateTime.new(1920,5,1,4,16,48),-15408,0,'CMT'))
