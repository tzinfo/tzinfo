...
class Ushuaia < Timezone #:nodoc:
setup
set_identifier('America/Argentina/Ushuaia')
add_unbounded_start_period {TimezonePeriod.new(nil,DateTime.new0(Rational.new!(8687277683,3600),0,Date::ITALY),-16392,0,:'LMT')}
add_period(1894,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(8687277683,3600),0,Date::ITALY),DateTime.new0(Rational.new!(1453467407,600),0,Date::ITALY),-15408,0,:'CMT')}
...
add_period(1991,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(29379823,12),0,Date::ITALY),DateTime.new0(Rational.new!(19588397,8),0,Date::ITALY),-10800,0,:'ART')}
...
add_period(2000,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(7354820,3),0,Date::ITALY),DateTime.new0(Rational.new!(19625245,8),0,Date::ITALY),-10800,0,:'ART')}
add_period(2004,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(19625245,8),0,Date::ITALY),DateTime.new0(Rational.new!(7359530,3),0,Date::ITALY),-14400,0,:'WART')}
