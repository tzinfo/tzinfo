...
add_period(TimezonePeriod.new(nil,DateTime.new(1894,10,31,4,33,12),-16392,0,'LMT'))
add_period(TimezonePeriod.new(DateTime.new(1894,10,31,4,33,12),DateTime.new(1920,5,1,4,16,48),-15408,0,'CMT'))
...
add_period(TimezonePeriod.new(DateTime.new(2000,3,3,4,0,0),DateTime.new(2004,5,30,3,0,0),-10800,0,'ART'))
add_period(TimezonePeriod.new(DateTime.new(2004,5,30,3,0,0),DateTime.new(2004,6,20,4,0,0),-14400,0,'WART'))
