...
add_unbounded_start_period {TimezonePeriod.new(nil,DateTime.new0(Rational.new!(52123666153,21600),0,Date::ITALY),-16612,0,:'LMT')}
add_period(1894,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(52123666153,21600),0,Date::ITALY),DateTime.new0(Rational.new!(1453467407,600),0,Date::ITALY),-15408,0,:'CMT')}
...
add_period(1991,3) {TimezonePeriod.new(667965600,687927600,-10800,0,:'ART')}
