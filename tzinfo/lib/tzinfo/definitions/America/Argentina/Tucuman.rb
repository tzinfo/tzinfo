...
class Tucuman < Timezone #:nodoc:
setup
set_identifier('America/Argentina/Tucuman')
add_unbounded_start_period {TimezonePeriod.new(nil,DateTime.new0(Rational.new!(52123665913,21600),0,Date::ITALY),-15652,0,:'LMT')}
add_period(1894,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(52123665913,21600),0,Date::ITALY),DateTime.new0(Rational.new!(1453467407,600),0,Date::ITALY),-15408,0,:'CMT')}
...
add_period(1990,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(19585485,8),0,Date::ITALY),DateTime.new0(Rational.new!(29379823,12),0,Date::ITALY),-10800,3600,:'ARST')}
add_period(1991,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(29379823,12),0,Date::ITALY),DateTime.new0(Rational.new!(7345649,3),0,Date::ITALY),-14400,0,:'WART')}
add_period(1991,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(7345649,3),0,Date::ITALY),DateTime.new0(Rational.new!(29384191,12),0,Date::ITALY),-10800,3600,:'ARST')}
...
add_period(2004,6) {TimezonePeriod.new(DateTime.new0(Rational.new!(19625261,8),0,Date::ITALY),DateTime.new0(Rational.new!(7359509,3),0,Date::ITALY),-14400,0,:'WART')}
add_period(2004,6) {TimezonePeriod.new(DateTime.new0(Rational.new!(7359509,3),0,Date::ITALY),nil,-10800,0,:'ART')}
end
end
end
end
