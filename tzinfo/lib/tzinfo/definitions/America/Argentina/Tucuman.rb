...
add_period(TimezonePeriod.new(nil,DateTime.new(1894,10,31,4,20,52),-15652,0,'LMT'))
add_period(TimezonePeriod.new(DateTime.new(1894,10,31,4,20,52),DateTime.new(1920,5,1,4,16,48),-15408,0,'CMT'))
...
add_period(TimezonePeriod.new(DateTime.new(2004,6,1,3,0,0),DateTime.new(2004,6,13,4,0,0),-14400,0,'WART'))
add_period(TimezonePeriod.new(DateTime.new(2004,6,13,4,0,0),nil,-10800,0,'ART'))
end
@@instance = new
def self.instance
   @@instance
