...
add_period(TimezonePeriod.new(nil,DateTime.new(1894,10,31,3,53,48),-14028,0,'LMT'))
add_period(TimezonePeriod.new(DateTime.new(1894,10,31,3,53,48),DateTime.new(1920,5,1,4,16,48),-15408,0,'CMT'))
