...
class Buenos_Aires < Timezone #:nodoc:
setup
set_identifier('America/Argentina/Buenos_Aires')
add_unbounded_start_period {TimezonePeriod.new(nil,DateTime.new0(Rational.new!(17374555169,7200),0,Date::ITALY),-14028,0,:'LMT')}
add_period(1894,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(17374555169,7200),0,Date::ITALY),DateTime.new0(Rational.new!(1453467407,600),0,Date::ITALY),-15408,0,:'CMT')}
