...
add_period(2000,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(7354820,3),0,Date::ITALY),DateTime.new0(Rational.new!(19625253,8),0,Date::ITALY),-10800,0,:'ART')}
add_period(2004,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(19625253,8),0,Date::ITALY),DateTime.new0(Rational.new!(7359635,3),0,Date::ITALY),-14400,0,:'WART')}
add_period(2004,7) {TimezonePeriod.new(DateTime.new0(Rational.new!(7359635,3),0,Date::ITALY),nil,-10800,0,:'ART')}
end
end
end
end
