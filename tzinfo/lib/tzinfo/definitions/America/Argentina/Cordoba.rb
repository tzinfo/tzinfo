...
class Cordoba < Timezone #:nodoc:
setup
set_identifier('America/Argentina/Cordoba')
add_unbounded_start_period {TimezonePeriod.new(nil,DateTime.new0(Rational.new!(1447879607,600),0,Date::ITALY),-15408,0,:'LMT')}
add_period(1894,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(1447879607,600),0,Date::ITALY),DateTime.new0(Rational.new!(1453467407,600),0,Date::ITALY),-15408,0,:'CMT')}
