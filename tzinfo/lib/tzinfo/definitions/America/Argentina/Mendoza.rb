...
add_period(TimezonePeriod.new(nil,DateTime.new(1894,10,31,4,35,16),-16516,0,'LMT'))
add_period(TimezonePeriod.new(DateTime.new(1894,10,31,4,35,16),DateTime.new(1920,5,1,4,16,48),-15408,0,'CMT'))
...
add_period(TimezonePeriod.new(DateTime.new(1990,3,4,2,0,0),DateTime.new(1990,10,15,4,0,0),-14400,0,'WART'))
add_period(TimezonePeriod.new(DateTime.new(1990,10,15,4,0,0),DateTime.new(1991,3,1,3,0,0),-14400,3600,'WARST'))
add_period(TimezonePeriod.new(DateTime.new(1991,3,1,3,0,0),DateTime.new(1991,10,15,4,0,0),-14400,0,'WART'))
add_period(TimezonePeriod.new(DateTime.new(1991,10,15,4,0,0),DateTime.new(1992,3,1,3,0,0),-14400,3600,'WARST'))
add_period(TimezonePeriod.new(DateTime.new(1992,3,1,3,0,0),DateTime.new(1992,10,18,4,0,0),-14400,0,'WART'))
add_period(TimezonePeriod.new(DateTime.new(1992,10,18,4,0,0),DateTime.new(1993,3,7,2,0,0),-10800,3600,'ARST'))
...
add_period(TimezonePeriod.new(DateTime.new(2000,3,3,4,0,0),DateTime.new(2004,5,23,3,0,0),-10800,0,'ART'))
add_period(TimezonePeriod.new(DateTime.new(2004,5,23,3,0,0),DateTime.new(2004,9,26,4,0,0),-14400,0,'WART'))
add_period(TimezonePeriod.new(DateTime.new(2004,9,26,4,0,0),nil,-10800,0,'ART'))
end
@@instance = new
def self.instance
   @@instance
