...
add_period(TimezonePeriod.new(nil,DateTime.new(1895,1,1,5,53,4),-21184,0,'LMT'))
add_period(TimezonePeriod.new(DateTime.new(1895,1,1,5,53,4),DateTime.new(1918,4,14,7,0,0),-18000,0,'ET'))
add_period(TimezonePeriod.new(DateTime.new(1918,4,14,7,0,0),DateTime.new(1918,10,31,6,0,0),-18000,3600,'EDT'))
add_period(TimezonePeriod.new(DateTime.new(1918,10,31,6,0,0),DateTime.new(1940,9,29,5,0,0),-18000,0,'EST'))
add_period(TimezonePeriod.new(DateTime.new(1940,9,29,5,0,0),DateTime.new(1942,2,9,7,0,0),-18000,3600,'EDT'))
add_period(TimezonePeriod.new(DateTime.new(1942,2,9,7,0,0),DateTime.new(1945,9,30,6,0,0),-18000,3600,'ET'))
add_period(TimezonePeriod.new(DateTime.new(1945,9,30,6,0,0),DateTime.new(1974,4,28,7,0,0),-18000,0,'EST'))
...
add_period(TimezonePeriod.new(DateTime.new(2045,4,2,7,0,0),DateTime.new(2045,8,19,20,49,17),-18000,3600,'EDT'))
end
@@instance = new
def self.instance
   @@instance
