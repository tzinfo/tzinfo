...
add_period(TimezonePeriod.new(nil,DateTime.new(1914,1,1,4,15,36),-15336,0,:'LMT'))
add_period(TimezonePeriod.new(DateTime.new(1914,1,1,4,15,36),DateTime.new(1931,10,3,15,0,0),-14400,0,:'AMT'))
...
add_period(TimezonePeriod.new(DateTime.new(1988,9,12,4,0,0),nil,-14400,0,:'AMT'))
end
end
end
end
