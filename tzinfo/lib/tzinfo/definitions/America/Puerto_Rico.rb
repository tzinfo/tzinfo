...
add_period(1942,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(7291448,3),0,Date::ITALY),DateTime.new0(Rational.new!(58361489,24),0,Date::ITALY),-14400,3600,:AWT)}
