...
add_period(1990,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(19585213,8),0,Date::ITALY),DateTime.new0(Rational.new!(19600029,8),0,Date::ITALY),-10800,0,:'BRT')}
add_period(1995,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(19600029,8),0,Date::ITALY),DateTime.new0(Rational.new!(19600045,8),0,Date::ITALY),-10800,0,:'BRT')}
...
add_period(1996,2) {TimezonePeriod.new(DateTime.new0(Rational.new!(29401495,12),0,Date::ITALY),DateTime.new0(Rational.new!(19602645,8),0,Date::ITALY),-10800,0,:'BRT')}
add_period(1996,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(19602645,8),0,Date::ITALY),DateTime.new0(Rational.new!(19611613,8),0,Date::ITALY),-10800,0,:'BRT')}
...
add_period(2000,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(19614605,8),0,Date::ITALY),DateTime.new0(Rational.new!(29422075,12),0,Date::ITALY),-10800,3600,:'BRST')}
add_period(2000,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(29422075,12),0,Date::ITALY),DateTime.new0(Rational.new!(19617325,8),0,Date::ITALY),-10800,0,:'BRT')}
