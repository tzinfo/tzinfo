...
add_period(TimezonePeriod.new(nil,DateTime.new(1914,1,1,2,22,52),-8572,0,'LMT'))
add_period(TimezonePeriod.new(DateTime.new(1914,1,1,2,22,52),DateTime.new(1931,10,3,14,0,0),-10800,0,'BRT'))
...
add_period(TimezonePeriod.new(DateTime.new(1990,2,11,2,0,0),DateTime.new(1990,9,17,3,0,0),-10800,0,'BRT'))
add_period(TimezonePeriod.new(DateTime.new(1990,9,17,3,0,0),DateTime.new(1995,10,13,3,0,0),-10800,0,'BRT'))
add_period(TimezonePeriod.new(DateTime.new(1995,10,13,3,0,0),DateTime.new(1995,10,15,3,0,0),-10800,0,'BRT'))
add_period(TimezonePeriod.new(DateTime.new(1995,10,15,3,0,0),DateTime.new(1996,2,11,2,0,0),-10800,3600,'BRST'))
add_period(TimezonePeriod.new(DateTime.new(1996,2,11,2,0,0),DateTime.new(1996,9,4,3,0,0),-10800,0,'BRT'))
add_period(TimezonePeriod.new(DateTime.new(1996,9,4,3,0,0),DateTime.new(1999,9,30,3,0,0),-10800,0,'BRT'))
add_period(TimezonePeriod.new(DateTime.new(1999,9,30,3,0,0),DateTime.new(1999,10,3,3,0,0),-10800,0,'BRT'))
...
add_period(TimezonePeriod.new(DateTime.new(2000,10,8,3,0,0),DateTime.new(2000,10,22,2,0,0),-10800,3600,'BRST'))
add_period(TimezonePeriod.new(DateTime.new(2000,10,22,2,0,0),DateTime.new(2001,9,13,3,0,0),-10800,0,'BRT'))
add_period(TimezonePeriod.new(DateTime.new(2001,9,13,3,0,0),DateTime.new(2001,10,14,3,0,0),-10800,0,'BRT'))
add_period(TimezonePeriod.new(DateTime.new(2001,10,14,3,0,0),DateTime.new(2002,2,17,2,0,0),-10800,3600,'BRST'))
add_period(TimezonePeriod.new(DateTime.new(2002,2,17,2,0,0),DateTime.new(2002,10,1,3,0,0),-10800,0,'BRT'))
add_period(TimezonePeriod.new(DateTime.new(2002,10,1,3,0,0),nil,-10800,0,'BRT'))
end
@@instance = new
def self.instance
   @@instance
