...
add_period(1884,1) {TimezonePeriod.new(DateTime.new0(Rational.new!(5203821739,2160),0,Date::ITALY),DateTime.new0(Rational.new!(58120747,24),0,Date::ITALY),-18000,0,:'EST')}
...
add_period(1945,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(9726915,4),0,Date::ITALY),nil,-18000,0,:'EST')}
end
end
end
end
