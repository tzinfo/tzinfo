...
add_period(1945,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(17508453503,7200),0,Date::ITALY),DateTime.new0(Rational.new!(117251359,48),0,Date::ITALY),-12600,0,:'NEGT')}
add_period(1975,11) {TimezonePeriod.new(DateTime.new0(Rational.new!(117251359,48),0,Date::ITALY),DateTime.new0(Rational.new!(117406783,48),0,Date::ITALY),-12600,0,:'SRT')}
add_period(1984,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(117406783,48),0,Date::ITALY),nil,-10800,0,:'SRT')}
end
end
end
end
