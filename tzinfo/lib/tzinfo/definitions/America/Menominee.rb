...
add_period(1885,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(69402333409,28800),0,Date::ITALY),DateTime.new0(Rational.new!(14530103,6),0,Date::ITALY),-21600,0,:'CST')}
...
add_period(1969,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(14642033,6),0,Date::ITALY),104914800,-18000,0,:'EST')}
add_period(1973,4) {TimezonePeriod.new(104914800,120639600,-21600,3600,:'CDT')}
