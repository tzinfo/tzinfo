...
add_period(1905,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(17403046493,7200),0,Date::ITALY),DateTime.new0(Rational.new!(19373583,8),0,Date::ITALY),-25200,0,:'MT')}
