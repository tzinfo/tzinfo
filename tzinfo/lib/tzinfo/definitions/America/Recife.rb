...
add_period(TimezonePeriod.new(nil,DateTime.new(1914,1,1,2,19,36),-8376,0,'LMT'))
add_period(TimezonePeriod.new(DateTime.new(1914,1,1,2,19,36),DateTime.new(1931,10,3,14,0,0),-10800,0,'BRT'))
...
add_period(TimezonePeriod.new(DateTime.new(2000,10,8,3,0,0),DateTime.new(2000,10,15,2,0,0),-10800,3600,'BRST'))
add_period(TimezonePeriod.new(DateTime.new(2000,10,15,2,0,0),DateTime.new(2001,9,13,3,0,0),-10800,0,'BRT'))
