...
add_period(1969,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(58572503,24),0,Date::ITALY),9979200,-36000,0,:'AHST')}
add_period(1970,4) {TimezonePeriod.new(9979200,25700400,-36000,3600,:'AHDT')}
add_period(1970,10) {TimezonePeriod.new(25700400,41428800,-36000,0,:'AHST')}
add_period(1971,4) {TimezonePeriod.new(41428800,57754800,-36000,3600,:'AHDT')}
add_period(1971,10) {TimezonePeriod.new(57754800,73483200,-36000,0,:'AHST')}
add_period(1972,4) {TimezonePeriod.new(73483200,89204400,-36000,3600,:'AHDT')}
add_period(1972,10) {TimezonePeriod.new(89204400,104932800,-36000,0,:'AHST')}
add_period(1973,4) {TimezonePeriod.new(104932800,120654000,-36000,3600,:'AHDT')}
add_period(1973,10) {TimezonePeriod.new(120654000,126705600,-36000,0,:'AHST')}
add_period(1974,1) {TimezonePeriod.new(126705600,152103600,-36000,3600,:'AHDT')}
add_period(1974,10) {TimezonePeriod.new(152103600,162388800,-36000,0,:'AHST')}
add_period(1975,2) {TimezonePeriod.new(162388800,183553200,-36000,3600,:'AHDT')}
add_period(1975,10) {TimezonePeriod.new(183553200,199281600,-36000,0,:'AHST')}
add_period(1976,4) {TimezonePeriod.new(199281600,215607600,-36000,3600,:'AHDT')}
add_period(1976,10) {TimezonePeriod.new(215607600,230731200,-36000,0,:'AHST')}
add_period(1977,4) {TimezonePeriod.new(230731200,247057200,-36000,3600,:'AHDT')}
add_period(1977,10) {TimezonePeriod.new(247057200,262785600,-36000,0,:'AHST')}
add_period(1978,4) {TimezonePeriod.new(262785600,278506800,-36000,3600,:'AHDT')}
add_period(1978,10) {TimezonePeriod.new(278506800,294235200,-36000,0,:'AHST')}
add_period(1979,4) {TimezonePeriod.new(294235200,309956400,-36000,3600,:'AHDT')}
add_period(1979,10) {TimezonePeriod.new(309956400,325684800,-36000,0,:'AHST')}
add_period(1980,4) {TimezonePeriod.new(325684800,341406000,-36000,3600,:'AHDT')}
add_period(1980,10) {TimezonePeriod.new(341406000,357134400,-36000,0,:'AHST')}
add_period(1981,4) {TimezonePeriod.new(357134400,372855600,-36000,3600,:'AHDT')}
add_period(1981,10) {TimezonePeriod.new(372855600,388584000,-36000,0,:'AHST')}
add_period(1982,4) {TimezonePeriod.new(388584000,404910000,-36000,3600,:'AHDT')}
add_period(1982,10) {TimezonePeriod.new(404910000,420033600,-36000,0,:'AHST')}
add_period(1983,4) {TimezonePeriod.new(420033600,436359600,-36000,3600,:'AHDT')}
add_period(1983,10) {TimezonePeriod.new(436359600,439030800,-32400,0,:'YST')}
...
add_period(2046,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(59241983,24),0,Date::ITALY),DateTime.new0(Rational.new!(29623847,12),0,Date::ITALY),-32400,3600,:'AKDT')}
add_period(2046,11) {TimezonePeriod.new(DateTime.new0(Rational.new!(29623847,12),0,Date::ITALY),DateTime.new0(Rational.new!(59250719,24),0,Date::ITALY),-32400,0,:'AKST')}
add_period(2047,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(59250719,24),0,Date::ITALY),DateTime.new0(Rational.new!(29628215,12),0,Date::ITALY),-32400,3600,:'AKDT')}
add_period(2047,11) {TimezonePeriod.new(DateTime.new0(Rational.new!(29628215,12),0,Date::ITALY),DateTime.new0(Rational.new!(59259455,24),0,Date::ITALY),-32400,0,:'AKST')}
add_period(2048,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(59259455,24),0,Date::ITALY),DateTime.new0(Rational.new!(29632583,12),0,Date::ITALY),-32400,3600,:'AKDT')}
add_period(2048,11) {TimezonePeriod.new(DateTime.new0(Rational.new!(29632583,12),0,Date::ITALY),DateTime.new0(Rational.new!(59268359,24),0,Date::ITALY),-32400,0,:'AKST')}
add_period(2049,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(59268359,24),0,Date::ITALY),DateTime.new0(Rational.new!(29637035,12),0,Date::ITALY),-32400,3600,:'AKDT')}
add_period(2049,11) {TimezonePeriod.new(DateTime.new0(Rational.new!(29637035,12),0,Date::ITALY),DateTime.new0(Rational.new!(59277095,24),0,Date::ITALY),-32400,0,:'AKST')}
add_period(2050,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(59277095,24),0,Date::ITALY),DateTime.new0(Rational.new!(29641403,12),0,Date::ITALY),-32400,3600,:'AKDT')}
add_period(2050,11) {TimezonePeriod.new(DateTime.new0(Rational.new!(29641403,12),0,Date::ITALY),nil,-32400,0,:'AKST')}
end
end
end
end
