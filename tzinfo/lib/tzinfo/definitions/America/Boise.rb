...
add_period(1973,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(14651903,6),0,Date::ITALY),DateTime.new0(Rational.new!(58609171,24),0,Date::ITALY),-25200,0,:'MST')}
add_period(1974,1) {TimezonePeriod.new(DateTime.new0(Rational.new!(58609171,24),0,Date::ITALY),DateTime.new0(Rational.new!(19536655,8),0,Date::ITALY),-25200,0,:'MST')}
add_period(1974,2) {TimezonePeriod.new(DateTime.new0(Rational.new!(19536655,8),0,Date::ITALY),DateTime.new0(Rational.new!(19539735,8),0,Date::ITALY),-25200,0,:'MT')}
