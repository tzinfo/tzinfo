...
add_unbounded_start_period {TimezonePeriod.new(nil,DateTime.new0(Rational.new!(1306872181,540),0,Date::ITALY),-14560,0,:'LMT')}
add_period(1914,1) {TimezonePeriod.new(DateTime.new0(Rational.new!(1306872181,540),0,Date::ITALY),DateTime.new0(Rational.new!(19412945,8),0,Date::ITALY),-14400,0,:'AMT')}
...
add_period(1988,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(7342250,3),0,Date::ITALY),DateTime.new0(Rational.new!(7354355,3),0,Date::ITALY),-14400,0,:'AMT')}
add_period(1999,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(7354355,3),0,Date::ITALY),DateTime.new0(Rational.new!(7354364,3),0,Date::ITALY),-14400,0,:'AMT')}
...
add_period(2000,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(7355477,3),0,Date::ITALY),DateTime.new0(Rational.new!(19614661,8),0,Date::ITALY),-14400,3600,:'AMST')}
add_period(2000,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(19614661,8),0,Date::ITALY),nil,-14400,0,:'AMT')}
end
end
end
end
