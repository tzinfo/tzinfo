...
add_period(1944,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(3500901781,1440),0,Date::ITALY),DateTime.new0(Rational.new!(3501165301,1440),0,Date::ITALY),-25200,0,:'MT')}
add_period(1944,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(3501165301,1440),0,Date::ITALY),DateTime.new0(Rational.new!(58547803,24),0,Date::ITALY),-25200,0,:'MST')}
...
add_period(1967,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(14638757,6),0,Date::ITALY),DateTime.new0(Rational.new!(58558483,24),0,Date::ITALY),-25200,0,:'MST')}
add_period(1968,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(58558483,24),0,Date::ITALY),nil,-25200,0,:'MST')}
end
end
end
end
