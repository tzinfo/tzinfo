...
add_period(1906,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(6527128001,2700),0,Date::ITALY),DateTime.new0(Rational.new!(19373583,8),0,Date::ITALY),-25200,0,:MST)}
...
add_period(1969,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(14643125,6),0,Date::ITALY),73472400,-25200,0,:MST)}
...
add_period(1973,10) {TimezonePeriod.new(120643200,136371600,-25200,0,:MST)}
add_period(1974,4) {TimezonePeriod.new(136371600,152092800,-25200,3600,:MDT)}
add_period(1974,10) {TimezonePeriod.new(152092800,167821200,-25200,0,:MST)}
add_period(1975,4) {TimezonePeriod.new(167821200,183542400,-25200,3600,:MDT)}
