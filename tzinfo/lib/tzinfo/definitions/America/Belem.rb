...
add_unbounded_start_period {TimezonePeriod.new(nil,DateTime.new0(Rational.new!(52274886509,21600),0,Date::ITALY),-11636,0,:'LMT')}
add_period(1914,1) {TimezonePeriod.new(DateTime.new0(Rational.new!(52274886509,21600),0,Date::ITALY),DateTime.new0(Rational.new!(29119417,12),0,Date::ITALY),-10800,0,:'BRT')}
...
add_period(1988,2) {TimezonePeriod.new(DateTime.new0(Rational.new!(29366383,12),0,Date::ITALY),DateTime.new0(Rational.new!(19579333,8),0,Date::ITALY),-10800,0,:'BRT')}
add_period(1988,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(19579333,8),0,Date::ITALY),nil,-10800,0,:'BRT')}
end
end
end
end
