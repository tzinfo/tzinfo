...
class Fortaleza < Timezone #:nodoc:
def initialize
  super
set_identifier('America/Fortaleza')
add_period(TimezonePeriod.new(nil,DateTime.new(1914,1,1,2,34,0),-9240,0,'LMT'))
add_period(TimezonePeriod.new(DateTime.new(1914,1,1,2,34,0),DateTime.new(1931,10,3,14,0,0),-10800,0,'BRT'))
...
add_period(TimezonePeriod.new(DateTime.new(1990,9,17,3,0,0),DateTime.new(1999,9,30,3,0,0),-10800,0,'BRT'))
