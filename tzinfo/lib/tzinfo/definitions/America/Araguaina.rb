...
class Araguaina < Timezone #:nodoc:
setup
set_identifier('America/Araguaina')
add_unbounded_start_period {TimezonePeriod.new(nil,DateTime.new0(Rational.new!(4356240541,1800),0,Date::ITALY),-11568,0,:'LMT')}
add_period(1914,1) {TimezonePeriod.new(DateTime.new0(Rational.new!(4356240541,1800),0,Date::ITALY),DateTime.new0(Rational.new!(29119417,12),0,Date::ITALY),-10800,0,:'BRT')}
...
add_period(1990,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(19585213,8),0,Date::ITALY),DateTime.new0(Rational.new!(19599797,8),0,Date::ITALY),-10800,0,:'BRT')}
add_period(1995,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(19599797,8),0,Date::ITALY),DateTime.new0(Rational.new!(19600045,8),0,Date::ITALY),-10800,0,:'BRT')}
