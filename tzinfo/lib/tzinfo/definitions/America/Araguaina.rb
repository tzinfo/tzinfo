...
add_period(TimezonePeriod.new(nil,DateTime.new(1914,1,1,3,12,48),-11568,0,'LMT'))
add_period(TimezonePeriod.new(DateTime.new(1914,1,1,3,12,48),DateTime.new(1931,10,3,14,0,0),-10800,0,'BRT'))
...
add_period(TimezonePeriod.new(DateTime.new(1990,9,17,3,0,0),DateTime.new(1995,9,14,3,0,0),-10800,0,'BRT'))
add_period(TimezonePeriod.new(DateTime.new(1995,9,14,3,0,0),DateTime.new(1995,10,15,3,0,0),-10800,0,'BRT'))
