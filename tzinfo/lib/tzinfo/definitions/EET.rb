...
def initialize
  super
set_identifier('EET')
add_period(TimezonePeriod.new(DateTime.new(1850,1,1,0,0,0),DateTime.new(1977,4,3,1,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1977,4,3,1,0,0),DateTime.new(1977,9,25,1,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1977,9,25,1,0,0),DateTime.new(1978,4,2,1,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1978,4,2,1,0,0),DateTime.new(1978,10,1,1,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1978,10,1,1,0,0),DateTime.new(1979,4,1,1,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1979,4,1,1,0,0),DateTime.new(1979,9,30,1,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1979,9,30,1,0,0),DateTime.new(1980,4,6,1,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1980,4,6,1,0,0),DateTime.new(1980,9,28,1,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1980,9,28,1,0,0),DateTime.new(1981,3,29,1,0,0),7200,0,'EET'))
...
add_period(TimezonePeriod.new(DateTime.new(2045,3,26,1,0,0),DateTime.new(2045,8,19,20,36,30),7200,3600,'EEST'))
end
@@instance = new
def self.instance
   @@instance
