...
class EET < Timezone #:nodoc:
setup
set_identifier('EET')
add_period(1850,1) {TimezonePeriod.new(DateTime.new0(Rational.new!(4793517,2),0,Date::ITALY),DateTime.new0(Rational.new!(58637677,24),0,Date::ITALY),7200,0,:'EET')}
add_period(1977,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(58637677,24),0,Date::ITALY),DateTime.new0(Rational.new!(58641877,24),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1977,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58641877,24),0,Date::ITALY),DateTime.new0(Rational.new!(58646413,24),0,Date::ITALY),7200,0,:'EET')}
add_period(1978,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(58646413,24),0,Date::ITALY),DateTime.new0(Rational.new!(58650781,24),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1978,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(58650781,24),0,Date::ITALY),DateTime.new0(Rational.new!(58655149,24),0,Date::ITALY),7200,0,:'EET')}
add_period(1979,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(58655149,24),0,Date::ITALY),DateTime.new0(Rational.new!(58659517,24),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1979,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58659517,24),0,Date::ITALY),DateTime.new0(Rational.new!(58664053,24),0,Date::ITALY),7200,0,:'EET')}
add_period(1980,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(58664053,24),0,Date::ITALY),DateTime.new0(Rational.new!(58668253,24),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1980,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58668253,24),0,Date::ITALY),DateTime.new0(Rational.new!(58672621,24),0,Date::ITALY),7200,0,:'EET')}
