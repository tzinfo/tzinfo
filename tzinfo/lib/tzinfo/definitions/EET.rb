...
setup
set_identifier('EET')
add_period(1850,1) {TimezonePeriod.new(DateTime.new0(Rational.new!(4793517,2),0,Date::ITALY),228877200,7200,0,:'EET')}
add_period(1977,4) {TimezonePeriod.new(228877200,243997200,7200,3600,:'EEST')}
add_period(1977,9) {TimezonePeriod.new(243997200,260326800,7200,0,:'EET')}
add_period(1978,4) {TimezonePeriod.new(260326800,276051600,7200,3600,:'EEST')}
add_period(1978,10) {TimezonePeriod.new(276051600,291776400,7200,0,:'EET')}
add_period(1979,4) {TimezonePeriod.new(291776400,307501200,7200,3600,:'EEST')}
add_period(1979,9) {TimezonePeriod.new(307501200,323830800,7200,0,:'EET')}
add_period(1980,4) {TimezonePeriod.new(323830800,338950800,7200,3600,:'EEST')}
add_period(1980,9) {TimezonePeriod.new(338950800,354675600,7200,0,:'EET')}
