    ...
    module Pacific
      module Easter
        ...
        timezone 'Pacific/Easter' do |tz|
          ...
          tz.transition 1966, 10, :o3, 7318223, 3
          tz.transition 1967, 3, :o2, 19516493, 8
          tz.transition 1967, 10, :o3, 7319336, 3
          tz.transition 1968, 3, :o2, 19519405, 8
          tz.transition 1968, 10, :o3, 7320428, 3
          tz.transition 1969, 3, :o2, 19522317, 8
          tz.transition 1969, 10, :o3, 7321520, 3
          tz.transition 1970, 3, :o2, 6318000
          ...
          tz.transition 1973, 10, :o3, 119419200
