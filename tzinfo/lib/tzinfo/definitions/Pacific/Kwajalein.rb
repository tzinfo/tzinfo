...
add_period(1969,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58571881,24),0,Date::ITALY),745848000,-43200,0,:'KWAT')}
add_period(1993,8) {TimezonePeriod.new(745848000,nil,43200,0,:'MHT')}
end
end
end
end
