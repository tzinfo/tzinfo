...
add_period(1940,12) {TimezonePeriod.new(DateTime.new0(Rational.new!(174959639,72),0,Date::ITALY),915102000,46800,0,:'TOT')}
add_period(1998,12) {TimezonePeriod.new(915102000,939214800,46800,0,:'TOT')}
