...
setup
set_identifier('WET')
add_unbounded_start_period {TimezonePeriod.new(nil,228877200,0,0,:WET)}
add_period(1977,4) {TimezonePeriod.new(228877200,243997200,0,3600,:WEST)}
add_period(1977,9) {TimezonePeriod.new(243997200,260326800,0,0,:WET)}
add_period(1978,4) {TimezonePeriod.new(260326800,276051600,0,3600,:WEST)}
add_period(1978,10) {TimezonePeriod.new(276051600,291776400,0,0,:WET)}
add_period(1979,4) {TimezonePeriod.new(291776400,307501200,0,3600,:WEST)}
add_period(1979,9) {TimezonePeriod.new(307501200,323830800,0,0,:WET)}
add_period(1980,4) {TimezonePeriod.new(323830800,338950800,0,3600,:WEST)}
