...
add_period(1944,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(19449401,8),0,Date::ITALY),47138400,36000,0,:'EST')}
add_period(1971,6) {TimezonePeriod.new(47138400,57686400,36000,0,:'EST')}
