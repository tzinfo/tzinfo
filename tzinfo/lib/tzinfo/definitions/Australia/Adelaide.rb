...
add_period(1944,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(116696407,48),0,Date::ITALY),31501800,34200,0,:'CST')}
add_period(1970,12) {TimezonePeriod.new(31501800,57688200,34200,0,:'CST')}
