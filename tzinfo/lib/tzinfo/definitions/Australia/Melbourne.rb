...
add_period(TimezonePeriod.new(nil,DateTime.new(1895,1,31,14,20,8),34792,0,'LMT'))
add_period(TimezonePeriod.new(DateTime.new(1895,1,31,14,20,8),DateTime.new(1916,12,31,14,1,0),36000,0,'EST'))
...
add_period(TimezonePeriod.new(DateTime.new(1981,10,24,16,0,0),DateTime.new(1982,3,6,16,0,0),36000,3600,'EST'))
add_period(TimezonePeriod.new(DateTime.new(1982,3,6,16,0,0),DateTime.new(1982,10,30,16,0,0),36000,0,'EST'))
...
add_period(TimezonePeriod.new(DateTime.new(1987,3,14,16,0,0),DateTime.new(1987,10,17,16,0,0),36000,0,'EST'))
add_period(TimezonePeriod.new(DateTime.new(1987,10,17,16,0,0),DateTime.new(1988,3,19,16,0,0),36000,3600,'EST'))
...
add_period(TimezonePeriod.new(DateTime.new(1994,10,29,16,0,0),DateTime.new(1995,3,25,16,0,0),36000,3600,'EST'))
add_period(TimezonePeriod.new(DateTime.new(1995,3,25,16,0,0),DateTime.new(1995,10,28,16,0,0),36000,0,'EST'))
...
add_period(TimezonePeriod.new(DateTime.new(2045,3,25,16,0,0),DateTime.new(2045,8,19,20,38,13),36000,0,'EST'))
end
@@instance = new
def self.instance
   @@instance
