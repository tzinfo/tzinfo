...
add_period(TimezonePeriod.new(DateTime.new(1913,6,1,0,53,0),DateTime.new(1935,6,1,1,0,0),-3600,0,:'Unknown'))
...
add_period(TimezonePeriod.new(DateTime.new(1957,1,1,1,0,0),DateTime.new(1957,6,1,0,0,0),0,0,:'Unknown'))
...
add_period(TimezonePeriod.new(DateTime.new(1962,8,31,23,0,0),DateTime.new(2045,9,3,22,27,56),0,0,:'GMT'))
end
end
end
end
