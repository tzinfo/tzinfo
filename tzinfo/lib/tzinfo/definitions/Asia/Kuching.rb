...
add_period(1945,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(19453681,8),0,Date::ITALY),378662400,28800,0,:BORT)}
add_period(1981,12) {TimezonePeriod.new(378662400,nil,28800,0,:MYT)}
end
end
end
end
