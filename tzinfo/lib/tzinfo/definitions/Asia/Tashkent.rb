...
add_period(TimezonePeriod.new(nil,DateTime.new(1924,5,1,19,22,48),16632,0,'LMT'))
add_period(TimezonePeriod.new(DateTime.new(1924,5,1,19,22,48),DateTime.new(1930,6,20,19,0,0),18000,0,'TAST'))
add_period(TimezonePeriod.new(DateTime.new(1930,6,20,19,0,0),DateTime.new(1981,3,31,18,0,0),21600,0,'TAST'))
add_period(TimezonePeriod.new(DateTime.new(1981,3,31,18,0,0),DateTime.new(1981,9,30,17,0,0),21600,3600,'TASST'))
add_period(TimezonePeriod.new(DateTime.new(1981,9,30,17,0,0),DateTime.new(1982,3,31,18,0,0),21600,0,'TAST'))
