...
add_period(1951,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(116828123,48),0,Date::ITALY),DateTime.new0(Rational.new!(9764145,4),0,Date::ITALY),21600,0,:'DACT')}
add_period(1971,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(9764145,4),0,Date::ITALY),nil,21600,0,:'BDT')}
end
end
end
end
