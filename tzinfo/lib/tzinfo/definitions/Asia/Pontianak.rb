...
add_period(1963,12) {TimezonePeriod.new(DateTime.new0(Rational.new!(39014323,16),0,Date::ITALY),567964800,28800,0,:CIT)}
add_period(1987,12) {TimezonePeriod.new(567964800,nil,25200,0,:WIT)}
end
end
end
end
