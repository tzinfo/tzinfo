...
add_unbounded_start_period {TimezonePeriod.new(nil,DateTime.new0(Rational.new!(130537991,54),0,Date::ITALY),25600,0,:LMT)}
add_period(1906,6) {TimezonePeriod.new(DateTime.new0(Rational.new!(130537991,54),0,Date::ITALY),DateTime.new0(Rational.new!(2612634701,1080),0,Date::ITALY),25580,0,:SMT)}
