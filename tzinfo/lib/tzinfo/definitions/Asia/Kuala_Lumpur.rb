...
add_period(1945,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(19453681,8),0,Date::ITALY),DateTime.new0(Rational.new!(39119523,16),0,Date::ITALY),27000,0,:'MALT')}
add_period(1981,12) {TimezonePeriod.new(DateTime.new0(Rational.new!(39119523,16),0,Date::ITALY),nil,28800,0,:'MYT')}
end
end
end
end
