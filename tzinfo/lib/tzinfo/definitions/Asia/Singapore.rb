...
add_period(TimezonePeriod.new(nil,DateTime.new(1900,12,31,17,4,35),24925,0,:'LMT'))
add_period(TimezonePeriod.new(DateTime.new(1900,12,31,17,4,35),DateTime.new(1905,5,31,17,4,35),24925,0,:'SMT'))
...
add_period(TimezonePeriod.new(DateTime.new(1945,9,11,15,0,0),DateTime.new(1965,8,8,16,30,0),27000,0,:'MALT'))
add_period(TimezonePeriod.new(DateTime.new(1965,8,8,16,30,0),DateTime.new(1981,12,31,16,30,0),27000,0,:'SGT'))
add_period(TimezonePeriod.new(DateTime.new(1981,12,31,16,30,0),nil,28800,0,:'SGT'))
end
end
end
end
