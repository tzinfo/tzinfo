...
module Europe #:nodoc:
class Simferopol < Timezone #:nodoc:
setup
set_identifier('Europe/Simferopol')
add_unbounded_start_period {TimezonePeriod.new(nil,DateTime.new0(Rational.new!(8667775459,3600),0,Date::ITALY),8184,0,:'LMT')}
add_period(1879,12) {TimezonePeriod.new(DateTime.new0(Rational.new!(8667775459,3600),0,Date::ITALY),DateTime.new0(Rational.new!(436303333,180),0,Date::ITALY),8160,0,:'SMT')}
add_period(1924,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(436303333,180),0,Date::ITALY),DateTime.new0(Rational.new!(29113781,12),0,Date::ITALY),7200,0,:'EET')}
add_period(1930,6) {TimezonePeriod.new(DateTime.new0(Rational.new!(29113781,12),0,Date::ITALY),DateTime.new0(Rational.new!(19442395,8),0,Date::ITALY),10800,0,:'MSK')}
add_period(1941,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(19442395,8),0,Date::ITALY),DateTime.new0(Rational.new!(58339501,24),0,Date::ITALY),3600,0,:'CET')}
...
add_period(1944,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(29174321,12),0,Date::ITALY),DateTime.new0(Rational.new!(7334635,3),0,Date::ITALY),10800,3600,:'MSD')}
...
add_period(1994,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(29393261,12),0,Date::ITALY),DateTime.new0(Rational.new!(19595787,8),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1994,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(19595787,8),0,Date::ITALY),DateTime.new0(Rational.new!(7348861,3),0,Date::ITALY),10800,3600,:'MSD')}
add_period(1994,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(7348861,3),0,Date::ITALY),DateTime.new0(Rational.new!(19598419,8),0,Date::ITALY),10800,0,:'MSK')}
add_period(1995,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(19598419,8),0,Date::ITALY),DateTime.new0(Rational.new!(7349953,3),0,Date::ITALY),10800,3600,:'MSD')}
add_period(1995,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(7349953,3),0,Date::ITALY),DateTime.new0(Rational.new!(19601387,8),0,Date::ITALY),10800,0,:'MSK')}
add_period(1996,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(19601387,8),0,Date::ITALY),DateTime.new0(Rational.new!(4900347,2),0,Date::ITALY),10800,3600,:'MSD')}
add_period(1996,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(4900347,2),0,Date::ITALY),DateTime.new0(Rational.new!(4900767,2),0,Date::ITALY),10800,3600,:'MSD')}
add_period(1996,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(58809203,24),0,Date::ITALY),DateTime.new0(Rational.new!(19603595,8),0,Date::ITALY),10800,0,:'MSK')}
add_period(1996,12) {TimezonePeriod.new(DateTime.new0(Rational.new!(19603595,8),0,Date::ITALY),DateTime.new0(Rational.new!(58812901,24),0,Date::ITALY),10800,0,:'MSK')}
