...
add_period(TimezonePeriod.new(nil,DateTime.new(1879,12,31,21,43,36),8184,0,'LMT'))
add_period(TimezonePeriod.new(DateTime.new(1879,12,31,21,43,36),DateTime.new(1924,5,1,21,44,0),8160,0,'SMT'))
add_period(TimezonePeriod.new(DateTime.new(1924,5,1,21,44,0),DateTime.new(1930,6,20,22,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1930,6,20,22,0,0),DateTime.new(1941,10,31,21,0,0),10800,0,'MSK'))
add_period(TimezonePeriod.new(DateTime.new(1941,10,31,21,0,0),DateTime.new(1943,3,29,1,0,0),3600,0,'CET'))
...
add_period(TimezonePeriod.new(DateTime.new(1944,4,3,1,0,0),DateTime.new(1944,4,12,22,0,0),3600,3600,'CEST'))
add_period(TimezonePeriod.new(DateTime.new(1944,4,12,22,0,0),DateTime.new(1981,9,30,20,0,0),10800,3600,'MSD'))
...
add_period(TimezonePeriod.new(DateTime.new(1989,12,31,21,0,0),DateTime.new(1990,6,30,23,0,0),10800,0,'MSK'))
add_period(TimezonePeriod.new(DateTime.new(1990,6,30,23,0,0),DateTime.new(1991,12,31,22,0,0),7200,0,'EET'))
...
add_period(TimezonePeriod.new(DateTime.new(1994,3,26,22,0,0),DateTime.new(1994,4,30,21,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1994,4,30,21,0,0),DateTime.new(1994,9,24,20,0,0),10800,3600,'MSD'))
add_period(TimezonePeriod.new(DateTime.new(1994,9,24,20,0,0),DateTime.new(1995,3,25,21,0,0),10800,0,'MSK'))
add_period(TimezonePeriod.new(DateTime.new(1995,3,25,21,0,0),DateTime.new(1995,9,23,20,0,0),10800,3600,'MSD'))
add_period(TimezonePeriod.new(DateTime.new(1995,9,23,20,0,0),DateTime.new(1996,3,30,21,0,0),10800,0,'MSK'))
add_period(TimezonePeriod.new(DateTime.new(1996,3,30,21,0,0),DateTime.new(1996,3,31,0,0,0),10800,3600,'MSD'))
add_period(TimezonePeriod.new(DateTime.new(1996,3,31,0,0,0),DateTime.new(1996,10,27,0,0,0),10800,3600,'MSD'))
add_period(TimezonePeriod.new(DateTime.new(1996,10,26,23,0,0),DateTime.new(1996,12,31,21,0,0),10800,0,'MSK'))
add_period(TimezonePeriod.new(DateTime.new(1996,12,31,21,0,0),DateTime.new(1997,3,30,1,0,0),10800,0,'MSK'))
...
add_period(TimezonePeriod.new(DateTime.new(2045,3,26,1,0,0),DateTime.new(2045,8,19,20,36,36),7200,3600,'EEST'))
end
@@instance = new
def self.instance
   @@instance
