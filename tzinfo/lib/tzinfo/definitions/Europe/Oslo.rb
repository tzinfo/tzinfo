...
add_period(1965,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58536541,24),0,Date::ITALY),315529200,3600,0,:'CET')}
add_period(1979,12) {TimezonePeriod.new(315529200,323830800,3600,0,:'CET')}
