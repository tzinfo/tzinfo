...
add_unbounded_start_period {TimezonePeriod.new(nil,DateTime.new0(Rational.new!(3475000037,1440),0,Date::ITALY),2580,0,:'LMT')}
add_period(1894,12) {TimezonePeriod.new(DateTime.new0(Rational.new!(3475000037,1440),0,Date::ITALY),DateTime.new0(Rational.new!(4842011,2),0,Date::ITALY),3600,0,:'CET')}
add_period(1916,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(4842011,2),0,Date::ITALY),DateTime.new0(Rational.new!(29053637,12),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1916,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(29053637,12),0,Date::ITALY),DateTime.new0(Rational.new!(29158229,12),0,Date::ITALY),3600,0,:'CET')}
add_period(1940,8) {TimezonePeriod.new(DateTime.new0(Rational.new!(29158229,12),0,Date::ITALY),DateTime.new0(Rational.new!(58339501,24),0,Date::ITALY),3600,0,:'CET')}
...
add_period(1945,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(58357141,24),0,Date::ITALY),DateTime.new0(Rational.new!(58361509,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1945,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(58361509,24),0,Date::ITALY),DateTime.new0(Rational.new!(58479421,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1959,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(58479421,24),0,Date::ITALY),DateTime.new0(Rational.new!(58483957,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1959,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58483957,24),0,Date::ITALY),DateTime.new0(Rational.new!(58488325,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1960,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(58488325,24),0,Date::ITALY),DateTime.new0(Rational.new!(58492693,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1960,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58492693,24),0,Date::ITALY),DateTime.new0(Rational.new!(58497061,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1961,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(58497061,24),0,Date::ITALY),DateTime.new0(Rational.new!(58501429,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1961,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58501429,24),0,Date::ITALY),DateTime.new0(Rational.new!(58505797,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1962,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(58505797,24),0,Date::ITALY),DateTime.new0(Rational.new!(58510165,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1962,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58510165,24),0,Date::ITALY),DateTime.new0(Rational.new!(58514533,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1963,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(58514533,24),0,Date::ITALY),DateTime.new0(Rational.new!(58518901,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1963,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58518901,24),0,Date::ITALY),DateTime.new0(Rational.new!(58523269,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1964,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(58523269,24),0,Date::ITALY),DateTime.new0(Rational.new!(58527805,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1964,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58527805,24),0,Date::ITALY),DateTime.new0(Rational.new!(58533013,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1965,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(58533013,24),0,Date::ITALY),DateTime.new0(Rational.new!(58536541,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1965,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58536541,24),0,Date::ITALY),DateTime.new0(Rational.new!(58661747,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1979,12) {TimezonePeriod.new(DateTime.new0(Rational.new!(58661747,24),0,Date::ITALY),DateTime.new0(Rational.new!(58664053,24),0,Date::ITALY),3600,0,:'CET')}
