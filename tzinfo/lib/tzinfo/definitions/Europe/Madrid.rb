...
add_unbounded_start_period {TimezonePeriod.new(nil,DateTime.new0(Rational.new!(52172327021,21600),0,Date::ITALY),-884,0,:'LMT')}
add_period(1901,1) {TimezonePeriod.new(DateTime.new0(Rational.new!(52172327021,21600),0,Date::ITALY),DateTime.new0(Rational.new!(58112507,24),0,Date::ITALY),0,0,:'WET')}
add_period(1917,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(58112507,24),0,Date::ITALY),DateTime.new0(Rational.new!(58116203,24),0,Date::ITALY),0,3600,:'WEST')}
add_period(1917,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(58116203,24),0,Date::ITALY),DateTime.new0(Rational.new!(58120787,24),0,Date::ITALY),0,0,:'WET')}
add_period(1918,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(58120787,24),0,Date::ITALY),DateTime.new0(Rational.new!(58124963,24),0,Date::ITALY),0,3600,:'WEST')}
add_period(1918,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(58124963,24),0,Date::ITALY),DateTime.new0(Rational.new!(58129307,24),0,Date::ITALY),0,0,:'WET')}
add_period(1919,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(58129307,24),0,Date::ITALY),DateTime.new0(Rational.new!(58133723,24),0,Date::ITALY),0,3600,:'WEST')}
add_period(1919,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(58133723,24),0,Date::ITALY),DateTime.new0(Rational.new!(58173419,24),0,Date::ITALY),0,0,:'WET')}
...
add_period(1929,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(58221371,24),0,Date::ITALY),DateTime.new0(Rational.new!(58288235,24),0,Date::ITALY),0,0,:'WET')}
add_period(1937,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(58288235,24),0,Date::ITALY),DateTime.new0(Rational.new!(58291427,24),0,Date::ITALY),0,3600,:'WEST')}
add_period(1937,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(58291427,24),0,Date::ITALY),DateTime.new0(Rational.new!(58295531,24),0,Date::ITALY),0,0,:'WET')}
add_period(1938,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(58295531,24),0,Date::ITALY),DateTime.new0(Rational.new!(58300163,24),0,Date::ITALY),0,3600,:'WEST')}
...
add_period(1939,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(58304867,24),0,Date::ITALY),DateTime.new0(Rational.new!(58309067,24),0,Date::ITALY),0,3600,:'WEST')}
add_period(1939,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(58309067,24),0,Date::ITALY),DateTime.new0(Rational.new!(58312931,24),0,Date::ITALY),0,0,:'WET')}
add_period(1940,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(58312931,24),0,Date::ITALY),DateTime.new0(Rational.new!(29165789,12),0,Date::ITALY),0,3600,:'WEST')}
add_period(1942,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(29165789,12),0,Date::ITALY),DateTime.new0(Rational.new!(29167253,12),0,Date::ITALY),0,7200,:'WEMT')}
add_period(1942,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(29167253,12),0,Date::ITALY),DateTime.new0(Rational.new!(29169989,12),0,Date::ITALY),0,3600,:'WEST')}
add_period(1943,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(29169989,12),0,Date::ITALY),DateTime.new0(Rational.new!(29172017,12),0,Date::ITALY),0,7200,:'WEMT')}
add_period(1943,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(29172017,12),0,Date::ITALY),DateTime.new0(Rational.new!(29174357,12),0,Date::ITALY),0,3600,:'WEST')}
add_period(1944,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(29174357,12),0,Date::ITALY),DateTime.new0(Rational.new!(29176493,12),0,Date::ITALY),0,7200,:'WEMT')}
add_period(1944,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(29176493,12),0,Date::ITALY),DateTime.new0(Rational.new!(29178725,12),0,Date::ITALY),0,3600,:'WEST')}
add_period(1945,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(29178725,12),0,Date::ITALY),DateTime.new0(Rational.new!(58361483,24),0,Date::ITALY),0,7200,:'WEMT')}
add_period(1945,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58361483,24),0,Date::ITALY),DateTime.new0(Rational.new!(29183093,12),0,Date::ITALY),0,3600,:'WEST')}
add_period(1946,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(29183093,12),0,Date::ITALY),DateTime.new0(Rational.new!(29185121,12),0,Date::ITALY),0,7200,:'WEMT')}
add_period(1946,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(29185121,12),0,Date::ITALY),DateTime.new0(Rational.new!(29196449,12),0,Date::ITALY),3600,0,:'CET')}
add_period(1949,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(29196449,12),0,Date::ITALY),DateTime.new0(Rational.new!(58396547,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1949,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58396547,24),0,Date::ITALY),DateTime.new0(Rational.new!(29305817,12),0,Date::ITALY),3600,0,:'CET')}
add_period(1974,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(29305817,12),0,Date::ITALY),DateTime.new0(Rational.new!(58615835,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1974,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(58615835,24),0,Date::ITALY),DateTime.new0(Rational.new!(29310269,12),0,Date::ITALY),3600,0,:'CET')}
add_period(1975,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(29310269,12),0,Date::ITALY),DateTime.new0(Rational.new!(58624571,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1975,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(58624571,24),0,Date::ITALY),DateTime.new0(Rational.new!(29314385,12),0,Date::ITALY),3600,0,:'CET')}
add_period(1976,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(29314385,12),0,Date::ITALY),DateTime.new0(Rational.new!(58633139,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1976,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58633139,24),0,Date::ITALY),DateTime.new0(Rational.new!(29318837,12),0,Date::ITALY),3600,0,:'CET')}
add_period(1977,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(29318837,12),0,Date::ITALY),DateTime.new0(Rational.new!(58641875,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1977,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58641875,24),0,Date::ITALY),DateTime.new0(Rational.new!(29323217,12),0,Date::ITALY),3600,0,:'CET')}
add_period(1978,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(29323217,12),0,Date::ITALY),DateTime.new0(Rational.new!(58650779,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1978,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58650779,24),0,Date::ITALY),DateTime.new0(Rational.new!(58652987,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1978,12) {TimezonePeriod.new(DateTime.new0(Rational.new!(58652987,24),0,Date::ITALY),DateTime.new0(Rational.new!(58655149,24),0,Date::ITALY),3600,0,:'CET')}
