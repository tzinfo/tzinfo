...
add_period(1949,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58396547,24),0,Date::ITALY),135122400,3600,0,:'CET')}
add_period(1974,4) {TimezonePeriod.new(135122400,150246000,3600,3600,:'CEST')}
add_period(1974,10) {TimezonePeriod.new(150246000,167176800,3600,0,:'CET')}
add_period(1975,4) {TimezonePeriod.new(167176800,181695600,3600,3600,:'CEST')}
add_period(1975,10) {TimezonePeriod.new(181695600,196812000,3600,0,:'CET')}
add_period(1976,3) {TimezonePeriod.new(196812000,212540400,3600,3600,:'CEST')}
add_period(1976,9) {TimezonePeriod.new(212540400,228866400,3600,0,:'CET')}
add_period(1977,4) {TimezonePeriod.new(228866400,243990000,3600,3600,:'CEST')}
add_period(1977,9) {TimezonePeriod.new(243990000,260402400,3600,0,:'CET')}
add_period(1978,4) {TimezonePeriod.new(260402400,276044400,3600,3600,:'CEST')}
add_period(1978,9) {TimezonePeriod.new(276044400,283993200,3600,0,:'CET')}
add_period(1978,12) {TimezonePeriod.new(283993200,291776400,3600,0,:'CET')}
