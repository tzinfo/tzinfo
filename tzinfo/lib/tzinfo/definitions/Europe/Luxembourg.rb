...
add_period(1940,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(29157163,12),0,Date::ITALY),DateTime.new0(Rational.new!(58339501,24),0,Date::ITALY),3600,0,:'WET')}
