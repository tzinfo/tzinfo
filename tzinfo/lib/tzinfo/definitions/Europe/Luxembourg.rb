...
add_period(1940,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(29157163,12),0,Date::ITALY),DateTime.new0(Rational.new!(58335973,24),0,Date::ITALY),3600,3600,:'WET')}
...
add_period(1944,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58352437,24),0,Date::ITALY),DateTime.new0(Rational.new!(58361149,24),0,Date::ITALY),3600,3600,:'CET')}
...
add_period(1946,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(58370413,24),0,Date::ITALY),220921200,3600,0,:'CET')}
