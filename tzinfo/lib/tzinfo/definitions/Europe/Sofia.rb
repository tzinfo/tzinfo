...
add_period(TimezonePeriod.new(nil,DateTime.new(1879,12,31,22,26,44),5596,0,'LMT'))
add_period(TimezonePeriod.new(DateTime.new(1879,12,31,22,26,44),DateTime.new(1894,11,29,22,3,4),7016,0,'IMT'))
add_period(TimezonePeriod.new(DateTime.new(1894,11,29,22,3,4),DateTime.new(1942,11,2,1,0,0),7200,0,'EET'))
...
add_period(TimezonePeriod.new(DateTime.new(1944,10,2,1,0,0),DateTime.new(1945,4,2,2,0,0),3600,0,'CET'))
add_period(TimezonePeriod.new(DateTime.new(1945,4,2,2,0,0),DateTime.new(1979,3,31,21,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1979,3,31,21,0,0),DateTime.new(1979,9,30,22,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1979,9,30,22,0,0),DateTime.new(1980,4,5,21,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1980,4,5,21,0,0),DateTime.new(1980,9,28,22,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1980,9,28,22,0,0),DateTime.new(1981,4,4,21,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1981,4,4,21,0,0),DateTime.new(1981,9,26,23,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1981,9,26,23,0,0),DateTime.new(1982,4,3,21,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1982,4,3,21,0,0),DateTime.new(1982,9,25,23,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1982,9,25,23,0,0),DateTime.new(1982,9,26,0,0,0),7200,3600,'EET'))
...
add_period(TimezonePeriod.new(DateTime.new(2045,3,26,1,0,0),DateTime.new(2045,8,19,20,39,1),7200,3600,'EEST'))
end
@@instance = new
def self.instance
   @@instance
