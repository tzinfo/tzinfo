...
add_period(1945,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(29178571,12),0,Date::ITALY),DateTime.new0(Rational.new!(19551715,8),0,Date::ITALY),7200,0,:'EET')}
add_period(1979,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(19551715,8),0,Date::ITALY),DateTime.new0(Rational.new!(29329769,12),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1979,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(29329769,12),0,Date::ITALY),DateTime.new0(Rational.new!(19554683,8),0,Date::ITALY),7200,0,:'EET')}
add_period(1980,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(19554683,8),0,Date::ITALY),DateTime.new0(Rational.new!(29334137,12),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1980,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(29334137,12),0,Date::ITALY),DateTime.new0(Rational.new!(19557595,8),0,Date::ITALY),7200,0,:'EET')}
add_period(1981,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(19557595,8),0,Date::ITALY),DateTime.new0(Rational.new!(58676987,24),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1981,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58676987,24),0,Date::ITALY),DateTime.new0(Rational.new!(19560507,8),0,Date::ITALY),7200,0,:'EET')}
add_period(1982,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(19560507,8),0,Date::ITALY),DateTime.new0(Rational.new!(58685723,24),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1982,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58685723,24),0,Date::ITALY),DateTime.new0(Rational.new!(4890477,2),0,Date::ITALY),7200,3600,:'EET')}
