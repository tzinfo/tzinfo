...
module Europe #:nodoc:
class Chisinau < Timezone #:nodoc:
setup
set_identifier('Europe/Chisinau')
add_unbounded_start_period {TimezonePeriod.new(nil,DateTime.new0(Rational.new!(5200665307,2160),0,Date::ITALY),6920,0,:'LMT')}
add_period(1879,12) {TimezonePeriod.new(DateTime.new0(Rational.new!(5200665307,2160),0,Date::ITALY),DateTime.new0(Rational.new!(697432153,288),0,Date::ITALY),6900,0,:'CMT')}
add_period(1918,2) {TimezonePeriod.new(DateTime.new0(Rational.new!(697432153,288),0,Date::ITALY),DateTime.new0(Rational.new!(970618571,400),0,Date::ITALY),6264,0,:'BMT')}
...
add_period(1939,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(29154449,12),0,Date::ITALY),DateTime.new0(Rational.new!(29158277,12),0,Date::ITALY),7200,0,:'EET')}
add_period(1940,8) {TimezonePeriod.new(DateTime.new0(Rational.new!(29158277,12),0,Date::ITALY),DateTime.new0(Rational.new!(19441539,8),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1941,7) {TimezonePeriod.new(DateTime.new0(Rational.new!(19441539,8),0,Date::ITALY),DateTime.new0(Rational.new!(58335973,24),0,Date::ITALY),3600,3600,:'CET')}
...
add_period(1944,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(58348405,24),0,Date::ITALY),DateTime.new0(Rational.new!(29175917,12),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1944,8) {TimezonePeriod.new(DateTime.new0(Rational.new!(29175917,12),0,Date::ITALY),DateTime.new0(Rational.new!(7334635,3),0,Date::ITALY),10800,3600,:'MSD')}
...
add_period(1989,12) {TimezonePeriod.new(DateTime.new0(Rational.new!(19583139,8),0,Date::ITALY),DateTime.new0(Rational.new!(19584139,8),0,Date::ITALY),10800,0,:'MSK')}
add_period(1990,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(19584139,8),0,Date::ITALY),DateTime.new0(Rational.new!(29379089,12),0,Date::ITALY),7200,0,:'EET')}
add_period(1990,12) {TimezonePeriod.new(DateTime.new0(Rational.new!(29379089,12),0,Date::ITALY),DateTime.new0(Rational.new!(4896693,2),0,Date::ITALY),7200,0,:'EET')}
...
add_period(1991,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(4897057,2),0,Date::ITALY),DateTime.new0(Rational.new!(29383469,12),0,Date::ITALY),7200,0,:'EET')}
