...
add_period(1944,8) {TimezonePeriod.new(DateTime.new0(Rational.new!(29175917,12),0,Date::ITALY),370728000,10800,3600,:'MSD')}
...
add_period(1989,12) {TimezonePeriod.new(631141200,641941200,10800,0,:'MSK')}
add_period(1990,5) {TimezonePeriod.new(641941200,662680800,7200,0,:'EET')}
add_period(1990,12) {TimezonePeriod.new(662680800,670377600,7200,0,:'EET')}
add_period(1991,3) {TimezonePeriod.new(670377600,686102400,7200,3600,:'EEST')}
add_period(1991,9) {TimezonePeriod.new(686102400,694216800,7200,0,:'EET')}
