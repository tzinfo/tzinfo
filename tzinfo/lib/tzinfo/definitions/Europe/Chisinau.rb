...
add_period(TimezonePeriod.new(nil,DateTime.new(1879,12,31,22,4,40),6920,0,'LMT'))
add_period(TimezonePeriod.new(DateTime.new(1879,12,31,22,4,40),DateTime.new(1918,2,14,22,5,0),6900,0,'CMT'))
add_period(TimezonePeriod.new(DateTime.new(1918,2,14,22,5,0),DateTime.new(1931,7,23,22,15,36),6264,0,'BMT'))
...
add_period(TimezonePeriod.new(DateTime.new(1939,9,30,22,0,0),DateTime.new(1940,8,14,22,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1940,8,14,22,0,0),DateTime.new(1941,7,16,21,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1941,7,16,21,0,0),DateTime.new(1942,11,2,1,0,0),3600,3600,'CET'))
...
add_period(TimezonePeriod.new(DateTime.new(1944,4,3,1,0,0),DateTime.new(1944,8,23,22,0,0),3600,3600,'CEST'))
add_period(TimezonePeriod.new(DateTime.new(1944,8,23,22,0,0),DateTime.new(1981,9,30,20,0,0),10800,3600,'MSD'))
...
add_period(TimezonePeriod.new(DateTime.new(1989,12,31,21,0,0),DateTime.new(1990,5,5,21,0,0),10800,0,'MSK'))
add_period(TimezonePeriod.new(DateTime.new(1990,5,5,21,0,0),DateTime.new(1990,12,31,22,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1990,12,31,22,0,0),DateTime.new(1991,3,31,0,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1991,3,31,0,0,0),DateTime.new(1991,9,29,0,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1991,9,29,0,0,0),DateTime.new(1991,12,31,22,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1991,12,31,22,0,0),DateTime.new(1992,3,28,22,0,0),7200,0,'EET'))
...
add_period(TimezonePeriod.new(DateTime.new(2045,3,26,1,0,0),DateTime.new(2045,8,19,20,38,47),7200,3600,'EEST'))
end
@@instance = new
def self.instance
   @@instance
