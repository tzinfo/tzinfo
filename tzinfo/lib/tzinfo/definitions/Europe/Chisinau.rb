...
add_period(1941,7) {TimezonePeriod.new(DateTime.new0(Rational.new!(19441539,8),0,Date::ITALY),DateTime.new0(Rational.new!(58335973,24),0,Date::ITALY),3600,3600,:'CEST')}
...
add_period(1989,9) {TimezonePeriod.new(622594800,641941200,10800,0,:'MSK')}
add_period(1990,5) {TimezonePeriod.new(641941200,670377600,7200,0,:'EET')}
...
add_period(1996,10) {TimezonePeriod.new(846363600,859683600,7200,0,:'EET')}
