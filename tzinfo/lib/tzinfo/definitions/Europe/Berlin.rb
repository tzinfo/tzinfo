...
add_unbounded_start_period {TimezonePeriod.new(nil,DateTime.new0(Rational.new!(26055588199,10800),0,Date::ITALY),3208,0,:'LMT')}
add_period(1893,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(26055588199,10800),0,Date::ITALY),DateTime.new0(Rational.new!(29051813,12),0,Date::ITALY),3600,0,:'CET')}
...
add_period(1945,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(58357141,24),0,Date::ITALY),DateTime.new0(Rational.new!(4863199,2),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1945,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(4863199,2),0,Date::ITALY),DateTime.new0(Rational.new!(4863445,2),0,Date::ITALY),3600,7200,:'CEMT')}
add_period(1945,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(4863445,2),0,Date::ITALY),DateTime.new0(Rational.new!(58362661,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1945,11) {TimezonePeriod.new(DateTime.new0(Rational.new!(58362661,24),0,Date::ITALY),DateTime.new0(Rational.new!(58366189,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1946,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(58366189,24),0,Date::ITALY),DateTime.new0(Rational.new!(58370413,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1946,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(58370413,24),0,Date::ITALY),DateTime.new0(Rational.new!(58374757,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1947,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(58374757,24),0,Date::ITALY),DateTime.new0(Rational.new!(58375597,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1947,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(58375597,24),0,Date::ITALY),DateTime.new0(Rational.new!(4864731,2),0,Date::ITALY),3600,7200,:'CEMT')}
add_period(1947,6) {TimezonePeriod.new(DateTime.new0(Rational.new!(4864731,2),0,Date::ITALY),DateTime.new0(Rational.new!(58379125,24),0,Date::ITALY),3600,3600,:'CEST')}
...
add_period(1949,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(58396597,24),0,Date::ITALY),DateTime.new0(Rational.new!(58661747,24),0,Date::ITALY),3600,0,:'CET')}
