...
add_period(1894,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(52120378229,21600),0,Date::ITALY),DateTime.new0(Rational.new!(58670531,24),0,Date::ITALY),3600,0,:'CET')}
