...
add_unbounded_start_period {TimezonePeriod.new(nil,DateTime.new0(Rational.new!(52120378229,21600),0,Date::ITALY),2284,0,:'LMT')}
add_period(1894,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(52120378229,21600),0,Date::ITALY),347151600,3600,0,:'CET')}
