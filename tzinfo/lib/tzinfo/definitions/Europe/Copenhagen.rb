...
add_unbounded_start_period {TimezonePeriod.new(nil,DateTime.new0(Rational.new!(10417111769,4320),0,Date::ITALY),3020,0,:'LMT')}
add_period(1889,12) {TimezonePeriod.new(DateTime.new0(Rational.new!(10417111769,4320),0,Date::ITALY),DateTime.new0(Rational.new!(10423423289,4320),0,Date::ITALY),3020,0,:'CMT')}
add_period(1893,12) {TimezonePeriod.new(DateTime.new0(Rational.new!(10423423289,4320),0,Date::ITALY),DateTime.new0(Rational.new!(29051981,12),0,Date::ITALY),3600,0,:'CET')}
add_period(1916,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(29051981,12),0,Date::ITALY),DateTime.new0(Rational.new!(19369099,8),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1916,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(19369099,8),0,Date::ITALY),DateTime.new0(Rational.new!(58314347,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1940,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(58314347,24),0,Date::ITALY),DateTime.new0(Rational.new!(58335973,24),0,Date::ITALY),3600,3600,:'CEST')}
...
add_period(1945,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(58357141,24),0,Date::ITALY),DateTime.new0(Rational.new!(58360381,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1945,8) {TimezonePeriod.new(DateTime.new0(Rational.new!(58360381,24),0,Date::ITALY),DateTime.new0(Rational.new!(58366597,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1946,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(58366597,24),0,Date::ITALY),DateTime.new0(Rational.new!(58369549,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1946,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58369549,24),0,Date::ITALY),DateTime.new0(Rational.new!(58375429,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1947,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(58375429,24),0,Date::ITALY),DateTime.new0(Rational.new!(58377781,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1947,8) {TimezonePeriod.new(DateTime.new0(Rational.new!(58377781,24),0,Date::ITALY),DateTime.new0(Rational.new!(58384333,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1948,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(58384333,24),0,Date::ITALY),DateTime.new0(Rational.new!(58386517,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1948,8) {TimezonePeriod.new(DateTime.new0(Rational.new!(58386517,24),0,Date::ITALY),DateTime.new0(Rational.new!(58661747,24),0,Date::ITALY),3600,0,:'CET')}
