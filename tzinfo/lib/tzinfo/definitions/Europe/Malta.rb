...
add_period(1972,9) {TimezonePeriod.new(86738400,102380400,3600,0,:'CET')}
add_period(1973,3) {TimezonePeriod.new(102380400,118105200,3600,3600,:'CEST')}
add_period(1973,9) {TimezonePeriod.new(118105200,135730800,3600,0,:'CET')}
add_period(1974,4) {TimezonePeriod.new(135730800,148518000,3600,3600,:'CEST')}
add_period(1974,9) {TimezonePeriod.new(148518000,167187600,3600,0,:'CET')}
add_period(1975,4) {TimezonePeriod.new(167187600,180489600,3600,3600,:'CEST')}
add_period(1975,9) {TimezonePeriod.new(180489600,198637200,3600,0,:'CET')}
add_period(1976,4) {TimezonePeriod.new(198637200,211939200,3600,3600,:'CEST')}
add_period(1976,9) {TimezonePeriod.new(211939200,230086800,3600,0,:'CET')}
add_period(1977,4) {TimezonePeriod.new(230086800,243388800,3600,3600,:'CEST')}
add_period(1977,9) {TimezonePeriod.new(243388800,261536400,3600,0,:'CET')}
add_period(1978,4) {TimezonePeriod.new(261536400,274838400,3600,3600,:'CEST')}
add_period(1978,9) {TimezonePeriod.new(274838400,292986000,3600,0,:'CET')}
add_period(1979,4) {TimezonePeriod.new(292986000,306288000,3600,3600,:'CEST')}
add_period(1979,9) {TimezonePeriod.new(306288000,323312400,3600,0,:'CET')}
add_period(1980,3) {TimezonePeriod.new(323312400,338342400,3600,3600,:'CEST')}
add_period(1980,9) {TimezonePeriod.new(338342400,347151600,3600,0,:'CET')}
add_period(1980,12) {TimezonePeriod.new(347151600,354675600,3600,0,:'CET')}
