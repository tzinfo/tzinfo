...
add_period(1945,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58361149,24),0,Date::ITALY),407199600,3600,0,:'CET')}
add_period(1982,11) {TimezonePeriod.new(407199600,417574800,3600,0,:'CET')}
