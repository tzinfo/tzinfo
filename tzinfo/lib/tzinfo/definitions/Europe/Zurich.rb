...
add_unbounded_start_period {TimezonePeriod.new(nil,DateTime.new0(Rational.new!(3234981343,1350),0,Date::ITALY),2048,0,:'LMT')}
add_period(1848,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(3234981343,1350),0,Date::ITALY),DateTime.new0(Rational.new!(26060189177,10800),0,Date::ITALY),1784,0,:'BMT')}
add_period(1894,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(26060189177,10800),0,Date::ITALY),DateTime.new0(Rational.new!(58318451,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1940,11) {TimezonePeriod.new(DateTime.new0(Rational.new!(58318451,24),0,Date::ITALY),DateTime.new0(Rational.new!(29159933,12),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1940,12) {TimezonePeriod.new(DateTime.new0(Rational.new!(29159933,12),0,Date::ITALY),DateTime.new0(Rational.new!(58322845,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1941,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(58322845,24),0,Date::ITALY),DateTime.new0(Rational.new!(29163269,12),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1941,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(29163269,12),0,Date::ITALY),DateTime.new0(Rational.new!(58331581,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1942,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(58331581,24),0,Date::ITALY),DateTime.new0(Rational.new!(29167637,12),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1942,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(29167637,12),0,Date::ITALY),347151600,3600,0,:'CET')}
