...
add_period(TimezonePeriod.new(nil,DateTime.new(1890,9,30,22,30,48),5352,0,'LMT'))
add_period(TimezonePeriod.new(DateTime.new(1890,9,30,22,30,48),DateTime.new(1939,12,31,23,0,0),3600,0,'CET'))
add_period(TimezonePeriod.new(DateTime.new(1939,12,31,23,0,0),DateTime.new(1940,4,1,1,0,0),3600,0,'CET'))
...
add_period(TimezonePeriod.new(DateTime.new(1944,9,30,22,0,0),DateTime.new(1944,10,25,22,0,0),3600,3600,'CEST'))
add_period(TimezonePeriod.new(DateTime.new(1944,10,25,22,0,0),DateTime.new(1945,6,28,23,0,0),3600,0,'CET'))
add_period(TimezonePeriod.new(DateTime.new(1945,6,28,23,0,0),DateTime.new(1981,3,31,21,0,0),10800,0,'MSK'))
...
add_period(TimezonePeriod.new(DateTime.new(1990,6,30,23,0,0),DateTime.new(1991,3,31,2,0,0),3600,0,'CET'))
add_period(TimezonePeriod.new(DateTime.new(1991,3,31,2,0,0),DateTime.new(1991,12,31,22,0,0),7200,0,'EET'))
...
add_period(TimezonePeriod.new(DateTime.new(2045,3,26,1,0,0),DateTime.new(2045,8,19,20,50,12),7200,3600,'EEST'))
end
@@instance = new
def self.instance
   @@instance
