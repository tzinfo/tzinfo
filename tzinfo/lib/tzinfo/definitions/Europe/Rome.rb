...
add_period(1972,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(29299097,12),0,Date::ITALY),DateTime.new0(Rational.new!(58604075,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1973,6) {TimezonePeriod.new(DateTime.new0(Rational.new!(58604075,24),0,Date::ITALY),DateTime.new0(Rational.new!(29303465,12),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1973,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(29303465,12),0,Date::ITALY),DateTime.new0(Rational.new!(58612643,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1974,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(58612643,24),0,Date::ITALY),DateTime.new0(Rational.new!(29307833,12),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1974,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(29307833,12),0,Date::ITALY),DateTime.new0(Rational.new!(58621547,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1975,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(58621547,24),0,Date::ITALY),DateTime.new0(Rational.new!(58624403,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1975,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58624403,24),0,Date::ITALY),DateTime.new0(Rational.new!(58630283,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1976,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(58630283,24),0,Date::ITALY),DateTime.new0(Rational.new!(58633139,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1976,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58633139,24),0,Date::ITALY),DateTime.new0(Rational.new!(58638851,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1977,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(58638851,24),0,Date::ITALY),DateTime.new0(Rational.new!(58641875,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1977,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58641875,24),0,Date::ITALY),DateTime.new0(Rational.new!(58647755,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1978,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(58647755,24),0,Date::ITALY),DateTime.new0(Rational.new!(58650779,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1978,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58650779,24),0,Date::ITALY),DateTime.new0(Rational.new!(58656491,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1979,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(58656491,24),0,Date::ITALY),DateTime.new0(Rational.new!(58659515,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1979,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58659515,24),0,Date::ITALY),DateTime.new0(Rational.new!(58661747,24),0,Date::ITALY),3600,0,:'CET')}
