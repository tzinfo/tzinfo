...
add_period(1944,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(29176265,12),0,Date::ITALY),354920400,10800,0,:'MSK')}
...
add_period(1998,9) {TimezonePeriod.new(906411600,922582800,7200,0,:'EET')}
