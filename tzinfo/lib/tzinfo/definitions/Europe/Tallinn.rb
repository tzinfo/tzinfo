...
add_period(TimezonePeriod.new(nil,DateTime.new(1879,12,31,22,21,0),5940,0,'LMT'))
add_period(TimezonePeriod.new(DateTime.new(1879,12,31,22,21,0),DateTime.new(1918,1,31,22,21,0),5940,0,'TMT'))
add_period(TimezonePeriod.new(DateTime.new(1918,1,31,22,21,0),DateTime.new(1918,4,15,1,0,0),3600,0,'CET'))
add_period(TimezonePeriod.new(DateTime.new(1918,4,15,1,0,0),DateTime.new(1918,9,16,1,0,0),3600,3600,'CEST'))
add_period(TimezonePeriod.new(DateTime.new(1918,9,16,1,0,0),DateTime.new(1919,6,30,23,0,0),3600,0,'CET'))
add_period(TimezonePeriod.new(DateTime.new(1919,6,30,23,0,0),DateTime.new(1921,4,30,22,21,0),5940,0,'TMT'))
add_period(TimezonePeriod.new(DateTime.new(1921,4,30,22,21,0),DateTime.new(1940,8,5,22,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1940,8,5,22,0,0),DateTime.new(1941,9,14,21,0,0),10800,0,'MSK'))
add_period(TimezonePeriod.new(DateTime.new(1941,9,14,21,0,0),DateTime.new(1943,3,29,1,0,0),3600,0,'CET'))
...
add_period(TimezonePeriod.new(DateTime.new(1944,4,3,1,0,0),DateTime.new(1944,9,21,22,0,0),3600,3600,'CEST'))
add_period(TimezonePeriod.new(DateTime.new(1944,9,21,22,0,0),DateTime.new(1981,9,30,20,0,0),10800,3600,'MSD'))
...
add_period(TimezonePeriod.new(DateTime.new(1998,3,29,0,0,0),DateTime.new(1998,9,21,21,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1998,9,21,21,0,0),DateTime.new(1998,10,25,1,0,0),7200,3600,'EET'))
...
add_period(TimezonePeriod.new(DateTime.new(1999,10,31,1,0,0),DateTime.new(1999,10,31,22,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1999,10,31,22,0,0),DateTime.new(2002,2,20,22,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(2002,2,20,22,0,0),DateTime.new(2002,3,31,1,0,0),7200,0,'EET'))
...
add_period(TimezonePeriod.new(DateTime.new(2045,3,26,1,0,0),DateTime.new(2045,8,19,20,51,26),7200,3600,'EEST'))
end
@@instance = new
def self.instance
   @@instance
