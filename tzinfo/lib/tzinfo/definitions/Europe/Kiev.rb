...
add_period(1941,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(19442059,8),0,Date::ITALY),DateTime.new0(Rational.new!(58335973,24),0,Date::ITALY),3600,3600,:'CEST')}
...
add_period(1989,9) {TimezonePeriod.new(622594800,646786800,10800,0,:'MSK')}
add_period(1990,6) {TimezonePeriod.new(646786800,701820000,7200,0,:'EET')}
