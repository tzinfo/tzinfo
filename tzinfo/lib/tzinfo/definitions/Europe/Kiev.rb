...
add_period(TimezonePeriod.new(nil,DateTime.new(1879,12,31,21,57,56),7324,0,'LMT'))
add_period(TimezonePeriod.new(DateTime.new(1879,12,31,21,57,56),DateTime.new(1924,5,1,21,57,56),7324,0,'KMT'))
add_period(TimezonePeriod.new(DateTime.new(1924,5,1,21,57,56),DateTime.new(1930,6,20,22,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1930,6,20,22,0,0),DateTime.new(1941,9,19,21,0,0),10800,0,'MSK'))
add_period(TimezonePeriod.new(DateTime.new(1941,9,19,21,0,0),DateTime.new(1943,3,29,1,0,0),3600,0,'CET'))
add_period(TimezonePeriod.new(DateTime.new(1943,3,29,1,0,0),DateTime.new(1943,10,4,1,0,0),3600,3600,'CEST'))
add_period(TimezonePeriod.new(DateTime.new(1943,10,4,1,0,0),DateTime.new(1943,11,5,23,0,0),3600,0,'CET'))
add_period(TimezonePeriod.new(DateTime.new(1943,11,5,23,0,0),DateTime.new(1981,3,31,21,0,0),10800,0,'MSK'))
...
add_period(TimezonePeriod.new(DateTime.new(2045,3,26,1,0,0),DateTime.new(2045,8,19,20,39,24),7200,3600,'EEST'))
end
@@instance = new
def self.instance
   @@instance
