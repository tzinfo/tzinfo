...
add_period(1944,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(58353035,24),0,Date::ITALY),DateTime.new0(Rational.new!(19557563,8),0,Date::ITALY),10800,0,:'MSK')}
...
add_period(1996,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(4900347,2),0,Date::ITALY),DateTime.new0(Rational.new!(4900711,2),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1996,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(4900711,2),0,Date::ITALY),DateTime.new0(Rational.new!(29405633,12),0,Date::ITALY),7200,0,:'EET')}
add_period(1997,1) {TimezonePeriod.new(DateTime.new0(Rational.new!(29405633,12),0,Date::ITALY),DateTime.new0(Rational.new!(58812901,24),0,Date::ITALY),7200,0,:'EET')}
...
add_period(1999,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(58835581,24),0,Date::ITALY),DateTime.new0(Rational.new!(29419241,12),0,Date::ITALY),7200,0,:'EET')}
add_period(2000,2) {TimezonePeriod.new(DateTime.new0(Rational.new!(29419241,12),0,Date::ITALY),DateTime.new0(Rational.new!(29422937,12),0,Date::ITALY),7200,0,:'EET')}
add_period(2001,1) {TimezonePeriod.new(DateTime.new0(Rational.new!(29422937,12),0,Date::ITALY),DateTime.new0(Rational.new!(58847845,24),0,Date::ITALY),7200,0,:'EET')}
