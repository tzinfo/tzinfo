...
add_period(TimezonePeriod.new(nil,DateTime.new(1879,12,31,22,23,36),5784,0,'LMT'))
add_period(TimezonePeriod.new(DateTime.new(1879,12,31,22,23,36),DateTime.new(1918,4,15,0,23,36),5784,0,'RMT'))
add_period(TimezonePeriod.new(DateTime.new(1918,4,15,0,23,36),DateTime.new(1918,9,16,0,23,36),5784,3600,'LST'))
add_period(TimezonePeriod.new(DateTime.new(1918,9,16,0,23,36),DateTime.new(1919,4,1,0,23,36),5784,0,'RMT'))
add_period(TimezonePeriod.new(DateTime.new(1919,4,1,0,23,36),DateTime.new(1919,5,22,0,23,36),5784,3600,'LST'))
add_period(TimezonePeriod.new(DateTime.new(1919,5,22,0,23,36),DateTime.new(1926,5,10,22,23,36),5784,0,'RMT'))
add_period(TimezonePeriod.new(DateTime.new(1926,5,10,22,23,36),DateTime.new(1940,8,4,22,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1940,8,4,22,0,0),DateTime.new(1941,6,30,21,0,0),10800,0,'MSK'))
add_period(TimezonePeriod.new(DateTime.new(1941,6,30,21,0,0),DateTime.new(1943,3,29,1,0,0),3600,0,'CET'))
...
add_period(TimezonePeriod.new(DateTime.new(1944,10,2,1,0,0),DateTime.new(1944,10,12,23,0,0),3600,0,'CET'))
add_period(TimezonePeriod.new(DateTime.new(1944,10,12,23,0,0),DateTime.new(1981,3,31,21,0,0),10800,0,'MSK'))
...
add_period(TimezonePeriod.new(DateTime.new(1989,3,25,23,0,0),DateTime.new(1989,9,24,0,0,0),7200,3600,'EEST'))
...
add_period(TimezonePeriod.new(DateTime.new(1990,9,30,0,0,0),DateTime.new(1991,3,31,0,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1991,3,31,0,0,0),DateTime.new(1991,9,29,0,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1991,9,29,0,0,0),DateTime.new(1992,3,29,0,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1992,3,29,0,0,0),DateTime.new(1992,9,27,0,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1992,9,27,0,0,0),DateTime.new(1993,3,28,0,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1993,3,28,0,0,0),DateTime.new(1993,9,26,0,0,0),7200,3600,'EEST'))
...
add_period(TimezonePeriod.new(DateTime.new(1996,3,31,0,0,0),DateTime.new(1996,9,29,0,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1996,9,29,0,0,0),DateTime.new(1997,1,20,22,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1997,1,20,22,0,0),DateTime.new(1997,3,30,1,0,0),7200,0,'EET'))
...
add_period(TimezonePeriod.new(DateTime.new(1999,10,31,1,0,0),DateTime.new(2000,2,28,22,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(2000,2,28,22,0,0),DateTime.new(2001,1,1,22,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(2001,1,1,22,0,0),DateTime.new(2001,3,25,1,0,0),7200,0,'EET'))
...
add_period(TimezonePeriod.new(DateTime.new(2045,3,26,1,0,0),DateTime.new(2045,8,19,20,37,58),7200,3600,'EEST'))
end
@@instance = new
def self.instance
   @@instance
