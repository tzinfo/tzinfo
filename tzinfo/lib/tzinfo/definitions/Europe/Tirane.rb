...
add_unbounded_start_period {TimezonePeriod.new(nil,DateTime.new0(Rational.new!(5227488241,2160),0,Date::ITALY),4760,0,:'LMT')}
add_period(1913,12) {TimezonePeriod.new(DateTime.new0(Rational.new!(5227488241,2160),0,Date::ITALY),DateTime.new0(Rational.new!(58315115,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1940,6) {TimezonePeriod.new(DateTime.new0(Rational.new!(58315115,24),0,Date::ITALY),DateTime.new0(Rational.new!(58335973,24),0,Date::ITALY),3600,3600,:'CEST')}
...
add_period(1943,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(58339501,24),0,Date::ITALY),DateTime.new0(Rational.new!(58339789,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1943,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(58339789,24),0,Date::ITALY),DateTime.new0(Rational.new!(58612115,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1974,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(58612115,24),0,Date::ITALY),DateTime.new0(Rational.new!(29307869,12),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1974,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(29307869,12),0,Date::ITALY),DateTime.new0(Rational.new!(58620803,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1975,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(58620803,24),0,Date::ITALY),DateTime.new0(Rational.new!(29312249,12),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1975,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(29312249,12),0,Date::ITALY),DateTime.new0(Rational.new!(58629611,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1976,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(58629611,24),0,Date::ITALY),DateTime.new0(Rational.new!(29316653,12),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1976,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(29316653,12),0,Date::ITALY),DateTime.new0(Rational.new!(58638515,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1977,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(58638515,24),0,Date::ITALY),DateTime.new0(Rational.new!(29321021,12),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1977,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(29321021,12),0,Date::ITALY),DateTime.new0(Rational.new!(58647227,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1978,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(58647227,24),0,Date::ITALY),DateTime.new0(Rational.new!(29325389,12),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1978,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(29325389,12),0,Date::ITALY),DateTime.new0(Rational.new!(58655963,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1979,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(58655963,24),0,Date::ITALY),DateTime.new0(Rational.new!(29329757,12),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1979,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(29329757,12),0,Date::ITALY),DateTime.new0(Rational.new!(58664699,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1980,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(58664699,24),0,Date::ITALY),DateTime.new0(Rational.new!(29334197,12),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1980,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(29334197,12),0,Date::ITALY),DateTime.new0(Rational.new!(58673291,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1981,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(58673291,24),0,Date::ITALY),DateTime.new0(Rational.new!(29338493,12),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1981,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(29338493,12),0,Date::ITALY),DateTime.new0(Rational.new!(58682195,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1982,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(58682195,24),0,Date::ITALY),DateTime.new0(Rational.new!(29342945,12),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1982,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(29342945,12),0,Date::ITALY),DateTime.new0(Rational.new!(58690619,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1983,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(58690619,24),0,Date::ITALY),DateTime.new0(Rational.new!(29347301,12),0,Date::ITALY),3600,3600,:'CEST')}
...
add_period(1984,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(58698995,24),0,Date::ITALY),DateTime.new0(Rational.new!(29350589,12),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1984,6) {TimezonePeriod.new(DateTime.new0(Rational.new!(29350589,12),0,Date::ITALY),DateTime.new0(Rational.new!(58703365,24),0,Date::ITALY),3600,3600,:'CET')}
