...
add_period(1943,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(58339789,24),0,Date::ITALY),136854000,3600,0,:'CET')}
add_period(1974,5) {TimezonePeriod.new(136854000,149896800,3600,3600,:'CEST')}
add_period(1974,10) {TimezonePeriod.new(149896800,168130800,3600,0,:'CET')}
add_period(1975,4) {TimezonePeriod.new(168130800,181432800,3600,3600,:'CEST')}
add_period(1975,10) {TimezonePeriod.new(181432800,199839600,3600,0,:'CET')}
add_period(1976,5) {TimezonePeriod.new(199839600,213141600,3600,3600,:'CEST')}
add_period(1976,10) {TimezonePeriod.new(213141600,231894000,3600,0,:'CET')}
add_period(1977,5) {TimezonePeriod.new(231894000,244591200,3600,3600,:'CEST')}
add_period(1977,10) {TimezonePeriod.new(244591200,263257200,3600,0,:'CET')}
add_period(1978,5) {TimezonePeriod.new(263257200,276040800,3600,3600,:'CEST')}
add_period(1978,9) {TimezonePeriod.new(276040800,294706800,3600,0,:'CET')}
add_period(1979,5) {TimezonePeriod.new(294706800,307490400,3600,3600,:'CEST')}
add_period(1979,9) {TimezonePeriod.new(307490400,326156400,3600,0,:'CET')}
add_period(1980,5) {TimezonePeriod.new(326156400,339458400,3600,3600,:'CEST')}
add_period(1980,10) {TimezonePeriod.new(339458400,357087600,3600,0,:'CET')}
add_period(1981,4) {TimezonePeriod.new(357087600,370389600,3600,3600,:'CEST')}
add_period(1981,9) {TimezonePeriod.new(370389600,389142000,3600,0,:'CET')}
add_period(1982,5) {TimezonePeriod.new(389142000,402444000,3600,3600,:'CEST')}
add_period(1982,10) {TimezonePeriod.new(402444000,419468400,3600,0,:'CET')}
add_period(1983,4) {TimezonePeriod.new(419468400,433807200,3600,3600,:'CEST')}
add_period(1983,9) {TimezonePeriod.new(433807200,449622000,3600,0,:'CET')}
add_period(1984,3) {TimezonePeriod.new(449622000,457480800,3600,3600,:'CEST')}
add_period(1984,6) {TimezonePeriod.new(457480800,465354000,3600,3600,:'CET')}
