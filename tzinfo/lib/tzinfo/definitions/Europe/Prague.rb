...
add_unbounded_start_period {TimezonePeriod.new(nil,DateTime.new0(Rational.new!(25884991367,10800),0,Date::ITALY),3464,0,:'LMT')}
add_period(1849,12) {TimezonePeriod.new(DateTime.new0(Rational.new!(25884991367,10800),0,Date::ITALY),DateTime.new0(Rational.new!(26049669767,10800),0,Date::ITALY),3464,0,:'PMT')}
add_period(1891,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(26049669767,10800),0,Date::ITALY),DateTime.new0(Rational.new!(29051813,12),0,Date::ITALY),3600,0,:'CET')}
...
add_period(1944,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(58348405,24),0,Date::ITALY),DateTime.new0(Rational.new!(58352413,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1944,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58352413,24),0,Date::ITALY),DateTime.new0(Rational.new!(58357285,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1945,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(58357285,24),0,Date::ITALY),DateTime.new0(Rational.new!(58362661,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1945,11) {TimezonePeriod.new(DateTime.new0(Rational.new!(58362661,24),0,Date::ITALY),DateTime.new0(Rational.new!(58366717,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1946,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(58366717,24),0,Date::ITALY),DateTime.new0(Rational.new!(58370389,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1946,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(58370389,24),0,Date::ITALY),DateTime.new0(Rational.new!(58375093,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1947,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(58375093,24),0,Date::ITALY),DateTime.new0(Rational.new!(58379125,24),0,Date::ITALY),3600,3600,:'CEST')}
...
add_period(1948,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(58387861,24),0,Date::ITALY),DateTime.new0(Rational.new!(58392373,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1949,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(58392373,24),0,Date::ITALY),DateTime.new0(Rational.new!(58396597,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1949,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(58396597,24),0,Date::ITALY),283993200,3600,0,:'CET')}
