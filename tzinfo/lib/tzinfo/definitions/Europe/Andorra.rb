...
add_unbounded_start_period {TimezonePeriod.new(nil,DateTime.new0(Rational.new!(52172326709,21600),0,Date::ITALY),364,0,:'LMT')}
add_period(1900,12) {TimezonePeriod.new(DateTime.new0(Rational.new!(52172326709,21600),0,Date::ITALY),DateTime.new0(Rational.new!(4864187,2),0,Date::ITALY),0,0,:'WET')}
add_period(1946,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(4864187,2),0,Date::ITALY),DateTime.new0(Rational.new!(58707733,24),0,Date::ITALY),3600,0,:'CET')}
