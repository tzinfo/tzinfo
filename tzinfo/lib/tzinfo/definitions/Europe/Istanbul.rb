    ...
    module Europe
      module Istanbul
        ...
        timezone 'Europe/Istanbul' do |tz|
          ...
          tz.transition 2007, 3, :o3, 1174777200
          tz.transition 2007, 10, :o2, 1193526000
          tz.transition 2008, 3, :o3, 1206831600
          tz.transition 2008, 10, :o2, 1224975600
          tz.transition 2009, 3, :o3, 1238281200
          tz.transition 2009, 10, :o2, 1256425200
          tz.transition 2010, 3, :o3, 1269730800
          tz.transition 2010, 10, :o2, 1288479600
          tz.transition 2011, 3, :o3, 1301180400
          tz.transition 2011, 10, :o2, 1319929200
          tz.transition 2012, 3, :o3, 1332630000
          tz.transition 2012, 10, :o2, 1351378800
          tz.transition 2013, 3, :o3, 1364684400
          tz.transition 2013, 10, :o2, 1382828400
          tz.transition 2014, 3, :o3, 1396134000
          tz.transition 2014, 10, :o2, 1414278000
          tz.transition 2015, 3, :o3, 1427583600
          tz.transition 2015, 10, :o2, 1445727600
          tz.transition 2016, 3, :o3, 1459033200
          tz.transition 2016, 10, :o2, 1477782000
          tz.transition 2017, 3, :o3, 1490482800
          tz.transition 2017, 10, :o2, 1509231600
          tz.transition 2018, 3, :o3, 1521932400
          tz.transition 2018, 10, :o2, 1540681200
          tz.transition 2019, 3, :o3, 1553986800
          tz.transition 2019, 10, :o2, 1572130800
          tz.transition 2020, 3, :o3, 1585436400
          tz.transition 2020, 10, :o2, 1603580400
          tz.transition 2021, 3, :o3, 1616886000
          tz.transition 2021, 10, :o2, 1635634800
          tz.transition 2022, 3, :o3, 1648335600
          tz.transition 2022, 10, :o2, 1667084400
          tz.transition 2023, 3, :o3, 1679785200
          tz.transition 2023, 10, :o2, 1698534000
          tz.transition 2024, 3, :o3, 1711839600
          tz.transition 2024, 10, :o2, 1729983600
          tz.transition 2025, 3, :o3, 1743289200
          tz.transition 2025, 10, :o2, 1761433200
          tz.transition 2026, 3, :o3, 1774738800
          tz.transition 2026, 10, :o2, 1792882800
          tz.transition 2027, 3, :o3, 1806188400
          tz.transition 2027, 10, :o2, 1824937200
          tz.transition 2028, 3, :o3, 1837638000
          tz.transition 2028, 10, :o2, 1856386800
          tz.transition 2029, 3, :o3, 1869087600
          tz.transition 2029, 10, :o2, 1887836400
          tz.transition 2030, 3, :o3, 1901142000
          tz.transition 2030, 10, :o2, 1919286000
          tz.transition 2031, 3, :o3, 1932591600
          tz.transition 2031, 10, :o2, 1950735600
          tz.transition 2032, 3, :o3, 1964041200
          tz.transition 2032, 10, :o2, 1982790000
          tz.transition 2033, 3, :o3, 1995490800
          tz.transition 2033, 10, :o2, 2014239600
          tz.transition 2034, 3, :o3, 2026940400
          tz.transition 2034, 10, :o2, 2045689200
          tz.transition 2035, 3, :o3, 2058390000
          tz.transition 2035, 10, :o2, 2077138800
          tz.transition 2036, 3, :o3, 2090444400
          tz.transition 2036, 10, :o2, 2108588400
          tz.transition 2037, 3, :o3, 2121894000
          tz.transition 2037, 10, :o2, 2140038000
          tz.transition 2038, 3, :o3, 59172251, 24
          tz.transition 2038, 10, :o2, 59177459, 24
          tz.transition 2039, 3, :o3, 59180987, 24
          tz.transition 2039, 10, :o2, 59186195, 24
          tz.transition 2040, 3, :o3, 59189723, 24
          tz.transition 2040, 10, :o2, 59194931, 24
          tz.transition 2041, 3, :o3, 59198627, 24
          tz.transition 2041, 10, :o2, 59203667, 24
          tz.transition 2042, 3, :o3, 59207363, 24
          tz.transition 2042, 10, :o2, 59212403, 24
          tz.transition 2043, 3, :o3, 59216099, 24
          tz.transition 2043, 10, :o2, 59221139, 24
          tz.transition 2044, 3, :o3, 59224835, 24
          tz.transition 2044, 10, :o2, 59230043, 24
          tz.transition 2045, 3, :o3, 59233571, 24
          tz.transition 2045, 10, :o2, 59238779, 24
          tz.transition 2046, 3, :o3, 59242307, 24
          tz.transition 2046, 10, :o2, 59247515, 24
          tz.transition 2047, 3, :o3, 59251211, 24
          tz.transition 2047, 10, :o2, 59256251, 24
          tz.transition 2048, 3, :o3, 59259947, 24
          tz.transition 2048, 10, :o2, 59264987, 24
          tz.transition 2049, 3, :o3, 59268683, 24
          tz.transition 2049, 10, :o2, 59273891, 24
          tz.transition 2050, 3, :o3, 59277419, 24
