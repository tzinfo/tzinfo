...
add_period(1957,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58466653,24),0,Date::ITALY),323827200,3600,0,:'CET')}
add_period(1980,4) {TimezonePeriod.new(323827200,338950800,3600,3600,:'CEST')}
