...
add_unbounded_start_period {TimezonePeriod.new(nil,DateTime.new0(Rational.new!(10418291051,4320),0,Date::ITALY),4580,0,:'LMT')}
add_period(1890,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(10418291051,4320),0,Date::ITALY),DateTime.new0(Rational.new!(29051813,12),0,Date::ITALY),3600,0,:'CET')}
...
add_period(1917,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58115725,24),0,Date::ITALY),DateTime.new0(Rational.new!(58118267,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1917,12) {TimezonePeriod.new(DateTime.new0(Rational.new!(58118267,24),0,Date::ITALY),DateTime.new0(Rational.new!(29060215,12),0,Date::ITALY),3600,0,:'CET')}
add_period(1918,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(29060215,12),0,Date::ITALY),DateTime.new0(Rational.new!(58124773,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1918,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58124773,24),0,Date::ITALY),DateTime.new0(Rational.new!(29064763,12),0,Date::ITALY),3600,0,:'CET')}
add_period(1919,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(29064763,12),0,Date::ITALY),DateTime.new0(Rational.new!(58133197,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1919,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58133197,24),0,Date::ITALY),DateTime.new0(Rational.new!(29069035,12),0,Date::ITALY),3600,0,:'CET')}
add_period(1920,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(29069035,12),0,Date::ITALY),DateTime.new0(Rational.new!(58142341,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1920,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58142341,24),0,Date::ITALY),DateTime.new0(Rational.new!(58322173,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1941,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(58322173,24),0,Date::ITALY),DateTime.new0(Rational.new!(58339501,24),0,Date::ITALY),3600,0,:'CET')}
...
add_period(1944,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(58352773,24),0,Date::ITALY),DateTime.new0(Rational.new!(29178929,12),0,Date::ITALY),3600,0,:'CET')}
add_period(1945,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(29178929,12),0,Date::ITALY),DateTime.new0(Rational.new!(29181149,12),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1945,11) {TimezonePeriod.new(DateTime.new0(Rational.new!(29181149,12),0,Date::ITALY),DateTime.new0(Rational.new!(58365853,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1946,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(58365853,24),0,Date::ITALY),DateTime.new0(Rational.new!(58370389,24),0,Date::ITALY),3600,3600,:'CEST')}
...
add_period(1947,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(58379125,24),0,Date::ITALY),DateTime.new0(Rational.new!(58383493,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1948,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(58383493,24),0,Date::ITALY),DateTime.new0(Rational.new!(58387861,24),0,Date::ITALY),3600,3600,:'CEST')}
...
add_period(1949,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(58396597,24),0,Date::ITALY),DateTime.new0(Rational.new!(58401325,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1950,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(58401325,24),0,Date::ITALY),DateTime.new0(Rational.new!(58405861,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1950,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(58405861,24),0,Date::ITALY),DateTime.new0(Rational.new!(58437251,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1954,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(58437251,24),0,Date::ITALY),DateTime.new0(Rational.new!(29220221,12),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1954,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(29220221,12),0,Date::ITALY),DateTime.new0(Rational.new!(58446011,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1955,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(58446011,24),0,Date::ITALY),DateTime.new0(Rational.new!(29224601,12),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1955,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(29224601,12),0,Date::ITALY),DateTime.new0(Rational.new!(58455059,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1956,6) {TimezonePeriod.new(DateTime.new0(Rational.new!(58455059,24),0,Date::ITALY),DateTime.new0(Rational.new!(29228957,12),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1956,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(29228957,12),0,Date::ITALY),DateTime.new0(Rational.new!(4871983,2),0,Date::ITALY),3600,0,:'CET')}
add_period(1957,6) {TimezonePeriod.new(DateTime.new0(Rational.new!(4871983,2),0,Date::ITALY),DateTime.new0(Rational.new!(58466653,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1957,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58466653,24),0,Date::ITALY),DateTime.new0(Rational.new!(4888671,2),0,Date::ITALY),3600,0,:'CET')}
add_period(1980,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(4888671,2),0,Date::ITALY),DateTime.new0(Rational.new!(58668253,24),0,Date::ITALY),3600,3600,:'CEST')}
