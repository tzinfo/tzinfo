...
add_unbounded_start_period {TimezonePeriod.new(nil,DateTime.new0(Rational.new!(17332923239,7200),0,Date::ITALY),4332,0,:'LMT')}
add_period(1878,12) {TimezonePeriod.new(DateTime.new0(Rational.new!(17332923239,7200),0,Date::ITALY),DateTime.new0(Rational.new!(104328883793,43200),0,Date::ITALY),3614,0,:'SET')}
add_period(1899,12) {TimezonePeriod.new(DateTime.new0(Rational.new!(104328883793,43200),0,Date::ITALY),DateTime.new0(Rational.new!(29051981,12),0,Date::ITALY),3600,0,:'CET')}
...
add_period(1916,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58107299,24),0,Date::ITALY),DateTime.new0(Rational.new!(58661747,24),0,Date::ITALY),3600,0,:'CET')}
