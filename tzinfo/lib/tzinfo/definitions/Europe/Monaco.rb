...
add_unbounded_start_period {TimezonePeriod.new(nil,DateTime.new0(Rational.new!(52095019957,21600),0,Date::ITALY),1772,0,:'LMT')}
add_period(1891,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(52095019957,21600),0,Date::ITALY),DateTime.new0(Rational.new!(69670267013,28800),0,Date::ITALY),561,0,:'PMT')}
...
add_period(1940,2) {TimezonePeriod.new(DateTime.new0(Rational.new!(29156215,12),0,Date::ITALY),DateTime.new0(Rational.new!(58322867,24),0,Date::ITALY),0,3600,:'WEST')}
add_period(1941,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(58322867,24),0,Date::ITALY),DateTime.new0(Rational.new!(29163281,12),0,Date::ITALY),0,7200,:'WEMT')}
add_period(1941,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(29163281,12),0,Date::ITALY),DateTime.new0(Rational.new!(58330259,24),0,Date::ITALY),0,3600,:'WEST')}
add_period(1942,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(58330259,24),0,Date::ITALY),DateTime.new0(Rational.new!(58335973,24),0,Date::ITALY),0,7200,:'WEMT')}
add_period(1942,11) {TimezonePeriod.new(DateTime.new0(Rational.new!(58335973,24),0,Date::ITALY),DateTime.new0(Rational.new!(58339501,24),0,Date::ITALY),0,3600,:'WEST')}
add_period(1943,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(58339501,24),0,Date::ITALY),DateTime.new0(Rational.new!(58344037,24),0,Date::ITALY),0,7200,:'WEMT')}
add_period(1943,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(58344037,24),0,Date::ITALY),DateTime.new0(Rational.new!(58348405,24),0,Date::ITALY),0,3600,:'WEST')}
add_period(1944,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(58348405,24),0,Date::ITALY),DateTime.new0(Rational.new!(58352915,24),0,Date::ITALY),0,7200,:'WEMT')}
...
add_period(1945,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58361149,24),0,Date::ITALY),DateTime.new0(Rational.new!(4885731,2),0,Date::ITALY),3600,0,:'CET')}
add_period(1976,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(4885731,2),0,Date::ITALY),DateTime.new0(Rational.new!(58633139,24),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1976,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58633139,24),0,Date::ITALY),DateTime.new0(Rational.new!(58635467,24),0,Date::ITALY),3600,0,:'CET')}
