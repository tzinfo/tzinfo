...
add_period(1940,6) {TimezonePeriod.new(DateTime.new0(Rational.new!(58315285,24),0,Date::ITALY),DateTime.new0(Rational.new!(58335973,24),0,Date::ITALY),3600,3600,:CEST)}
...
add_period(1944,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(58348405,24),0,Date::ITALY),DateTime.new0(Rational.new!(4862735,2),0,Date::ITALY),3600,3600,:CEST)}
...
add_period(1964,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(4877331,2),0,Date::ITALY),228873600,3600,0,:CET)}
add_period(1977,4) {TimezonePeriod.new(228873600,243993600,3600,3600,:CEST)}
add_period(1977,9) {TimezonePeriod.new(243993600,260323200,3600,0,:CET)}
add_period(1978,4) {TimezonePeriod.new(260323200,276048000,3600,3600,:CEST)}
add_period(1978,10) {TimezonePeriod.new(276048000,291772800,3600,0,:CET)}
add_period(1979,4) {TimezonePeriod.new(291772800,307497600,3600,3600,:CEST)}
add_period(1979,9) {TimezonePeriod.new(307497600,323827200,3600,0,:CET)}
add_period(1980,4) {TimezonePeriod.new(323827200,338947200,3600,3600,:CEST)}
add_period(1980,9) {TimezonePeriod.new(338947200,354672000,3600,0,:CET)}
add_period(1981,3) {TimezonePeriod.new(354672000,370396800,3600,3600,:CEST)}
add_period(1981,9) {TimezonePeriod.new(370396800,386121600,3600,0,:CET)}
add_period(1982,3) {TimezonePeriod.new(386121600,401846400,3600,3600,:CEST)}
add_period(1982,9) {TimezonePeriod.new(401846400,417571200,3600,0,:CET)}
add_period(1983,3) {TimezonePeriod.new(417571200,433296000,3600,3600,:CEST)}
add_period(1983,9) {TimezonePeriod.new(433296000,449020800,3600,0,:CET)}
add_period(1984,3) {TimezonePeriod.new(449020800,465350400,3600,3600,:CEST)}
add_period(1984,9) {TimezonePeriod.new(465350400,481075200,3600,0,:CET)}
add_period(1985,3) {TimezonePeriod.new(481075200,496800000,3600,3600,:CEST)}
add_period(1985,9) {TimezonePeriod.new(496800000,512524800,3600,0,:CET)}
add_period(1986,3) {TimezonePeriod.new(512524800,528249600,3600,3600,:CEST)}
add_period(1986,9) {TimezonePeriod.new(528249600,543974400,3600,0,:CET)}
add_period(1987,3) {TimezonePeriod.new(543974400,559699200,3600,3600,:CEST)}
add_period(1987,9) {TimezonePeriod.new(559699200,575427600,3600,0,:CET)}
