...
add_period(1941,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(19440915,8),0,Date::ITALY),DateTime.new0(Rational.new!(58335973,24),0,Date::ITALY),3600,3600,:'CET')}
...
add_period(1952,11) {TimezonePeriod.new(DateTime.new0(Rational.new!(19474547,8),0,Date::ITALY),DateTime.new0(Rational.new!(29310173,12),0,Date::ITALY),7200,0,:'EET')}
add_period(1975,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(29310173,12),0,Date::ITALY),DateTime.new0(Rational.new!(29312909,12),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1975,11) {TimezonePeriod.new(DateTime.new0(Rational.new!(29312909,12),0,Date::ITALY),DateTime.new0(Rational.new!(4885759,2),0,Date::ITALY),7200,0,:'EET')}
add_period(1976,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(4885759,2),0,Date::ITALY),DateTime.new0(Rational.new!(4886123,2),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1976,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(4886123,2),0,Date::ITALY),DateTime.new0(Rational.new!(4886473,2),0,Date::ITALY),7200,0,:'EET')}
add_period(1977,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(4886473,2),0,Date::ITALY),DateTime.new0(Rational.new!(4886825,2),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1977,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(4886825,2),0,Date::ITALY),DateTime.new0(Rational.new!(4887201,2),0,Date::ITALY),7200,0,:'EET')}
add_period(1978,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(4887201,2),0,Date::ITALY),DateTime.new0(Rational.new!(58650613,24),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1978,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58650613,24),0,Date::ITALY),DateTime.new0(Rational.new!(58655155,24),0,Date::ITALY),7200,0,:'EET')}
add_period(1979,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(58655155,24),0,Date::ITALY),DateTime.new0(Rational.new!(58659491,24),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1979,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58659491,24),0,Date::ITALY),DateTime.new0(Rational.new!(29331965,12),0,Date::ITALY),7200,0,:'EET')}
add_period(1980,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(29331965,12),0,Date::ITALY),DateTime.new0(Rational.new!(19556083,8),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1980,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(19556083,8),0,Date::ITALY),DateTime.new0(Rational.new!(29335265,12),0,Date::ITALY),7200,0,:'EET')}
add_period(1980,12) {TimezonePeriod.new(DateTime.new0(Rational.new!(29335265,12),0,Date::ITALY),DateTime.new0(Rational.new!(58672621,24),0,Date::ITALY),7200,0,:'EET')}
add_period(1981,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(58672621,24),0,Date::ITALY),DateTime.new0(Rational.new!(58676989,24),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1981,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58676989,24),0,Date::ITALY),DateTime.new0(Rational.new!(58681357,24),0,Date::ITALY),7200,0,:'EET')}
add_period(1982,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(58681357,24),0,Date::ITALY),DateTime.new0(Rational.new!(58685725,24),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1982,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58685725,24),0,Date::ITALY),DateTime.new0(Rational.new!(58690093,24),0,Date::ITALY),7200,0,:'EET')}
add_period(1983,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(58690093,24),0,Date::ITALY),DateTime.new0(Rational.new!(58694461,24),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1983,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58694461,24),0,Date::ITALY),DateTime.new0(Rational.new!(58698829,24),0,Date::ITALY),7200,0,:'EET')}
add_period(1984,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(58698829,24),0,Date::ITALY),DateTime.new0(Rational.new!(58703365,24),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1984,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58703365,24),0,Date::ITALY),DateTime.new0(Rational.new!(58707733,24),0,Date::ITALY),7200,0,:'EET')}
add_period(1985,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(58707733,24),0,Date::ITALY),DateTime.new0(Rational.new!(58712101,24),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1985,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58712101,24),0,Date::ITALY),DateTime.new0(Rational.new!(58716469,24),0,Date::ITALY),7200,0,:'EET')}
add_period(1986,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(58716469,24),0,Date::ITALY),DateTime.new0(Rational.new!(58720837,24),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1986,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58720837,24),0,Date::ITALY),DateTime.new0(Rational.new!(58725205,24),0,Date::ITALY),7200,0,:'EET')}
add_period(1987,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(58725205,24),0,Date::ITALY),DateTime.new0(Rational.new!(58729573,24),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1987,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58729573,24),0,Date::ITALY),DateTime.new0(Rational.new!(58733941,24),0,Date::ITALY),7200,0,:'EET')}
add_period(1988,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(58733941,24),0,Date::ITALY),DateTime.new0(Rational.new!(58738309,24),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1988,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58738309,24),0,Date::ITALY),DateTime.new0(Rational.new!(58742677,24),0,Date::ITALY),7200,0,:'EET')}
add_period(1989,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(58742677,24),0,Date::ITALY),DateTime.new0(Rational.new!(58747045,24),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1989,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58747045,24),0,Date::ITALY),DateTime.new0(Rational.new!(58751413,24),0,Date::ITALY),7200,0,:'EET')}
add_period(1990,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(58751413,24),0,Date::ITALY),DateTime.new0(Rational.new!(58755949,24),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1990,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(58755949,24),0,Date::ITALY),DateTime.new0(Rational.new!(58760317,24),0,Date::ITALY),7200,0,:'EET')}
