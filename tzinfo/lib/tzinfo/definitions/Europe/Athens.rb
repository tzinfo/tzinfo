...
add_period(TimezonePeriod.new(nil,DateTime.new(1895,9,13,22,25,8),5692,0,:'LMT'))
add_period(TimezonePeriod.new(DateTime.new(1895,9,13,22,25,8),DateTime.new(1916,7,27,22,26,8),5692,0,:'AMT'))
add_period(TimezonePeriod.new(DateTime.new(1916,7,27,22,26,8),DateTime.new(1932,7,6,22,0,0),7200,0,:'EET'))
add_period(TimezonePeriod.new(DateTime.new(1932,7,6,22,0,0),DateTime.new(1932,8,31,21,0,0),7200,3600,:'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1932,8,31,21,0,0),DateTime.new(1941,4,6,22,0,0),7200,0,:'EET'))
add_period(TimezonePeriod.new(DateTime.new(1941,4,6,22,0,0),DateTime.new(1941,4,29,21,0,0),7200,3600,:'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1941,4,29,21,0,0),DateTime.new(1942,11,2,1,0,0),3600,3600,:'CET'))
add_period(TimezonePeriod.new(DateTime.new(1942,11,2,1,0,0),DateTime.new(1943,3,29,23,0,0),3600,0,:'CET'))
add_period(TimezonePeriod.new(DateTime.new(1943,3,29,23,0,0),DateTime.new(1943,10,3,22,0,0),3600,3600,:'CEST'))
add_period(TimezonePeriod.new(DateTime.new(1943,10,3,22,0,0),DateTime.new(1944,4,3,23,0,0),3600,0,:'CET'))
add_period(TimezonePeriod.new(DateTime.new(1944,4,3,23,0,0),DateTime.new(1952,6,30,22,0,0),7200,0,:'EET'))
add_period(TimezonePeriod.new(DateTime.new(1952,6,30,22,0,0),DateTime.new(1952,11,1,21,0,0),7200,3600,:'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1952,11,1,21,0,0),DateTime.new(1975,4,11,22,0,0),7200,0,:'EET'))
add_period(TimezonePeriod.new(DateTime.new(1975,4,11,22,0,0),DateTime.new(1975,11,25,22,0,0),7200,3600,:'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1975,11,25,22,0,0),DateTime.new(1976,4,11,0,0,0),7200,0,:'EET'))
add_period(TimezonePeriod.new(DateTime.new(1976,4,11,0,0,0),DateTime.new(1976,10,10,0,0,0),7200,3600,:'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1976,10,10,0,0,0),DateTime.new(1977,4,3,0,0,0),7200,0,:'EET'))
add_period(TimezonePeriod.new(DateTime.new(1977,4,3,0,0,0),DateTime.new(1977,9,26,0,0,0),7200,3600,:'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1977,9,26,0,0,0),DateTime.new(1978,4,2,0,0,0),7200,0,:'EET'))
add_period(TimezonePeriod.new(DateTime.new(1978,4,2,0,0,0),DateTime.new(1978,9,24,1,0,0),7200,3600,:'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1978,9,24,1,0,0),DateTime.new(1979,4,1,7,0,0),7200,0,:'EET'))
add_period(TimezonePeriod.new(DateTime.new(1979,4,1,7,0,0),DateTime.new(1979,9,28,23,0,0),7200,3600,:'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1979,9,28,23,0,0),DateTime.new(1980,3,31,22,0,0),7200,0,:'EET'))
add_period(TimezonePeriod.new(DateTime.new(1980,3,31,22,0,0),DateTime.new(1980,9,27,21,0,0),7200,3600,:'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1980,9,27,21,0,0),DateTime.new(1980,12,31,22,0,0),7200,0,:'EET'))
add_period(TimezonePeriod.new(DateTime.new(1980,12,31,22,0,0),DateTime.new(1981,3,29,1,0,0),7200,0,:'EET'))
add_period(TimezonePeriod.new(DateTime.new(1981,3,29,1,0,0),DateTime.new(1981,9,27,1,0,0),7200,3600,:'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1981,9,27,1,0,0),DateTime.new(1982,3,28,1,0,0),7200,0,:'EET'))
add_period(TimezonePeriod.new(DateTime.new(1982,3,28,1,0,0),DateTime.new(1982,9,26,1,0,0),7200,3600,:'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1982,9,26,1,0,0),DateTime.new(1983,3,27,1,0,0),7200,0,:'EET'))
add_period(TimezonePeriod.new(DateTime.new(1983,3,27,1,0,0),DateTime.new(1983,9,25,1,0,0),7200,3600,:'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1983,9,25,1,0,0),DateTime.new(1984,3,25,1,0,0),7200,0,:'EET'))
add_period(TimezonePeriod.new(DateTime.new(1984,3,25,1,0,0),DateTime.new(1984,9,30,1,0,0),7200,3600,:'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1984,9,30,1,0,0),DateTime.new(1985,3,31,1,0,0),7200,0,:'EET'))
add_period(TimezonePeriod.new(DateTime.new(1985,3,31,1,0,0),DateTime.new(1985,9,29,1,0,0),7200,3600,:'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1985,9,29,1,0,0),DateTime.new(1986,3,30,1,0,0),7200,0,:'EET'))
add_period(TimezonePeriod.new(DateTime.new(1986,3,30,1,0,0),DateTime.new(1986,9,28,1,0,0),7200,3600,:'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1986,9,28,1,0,0),DateTime.new(1987,3,29,1,0,0),7200,0,:'EET'))
add_period(TimezonePeriod.new(DateTime.new(1987,3,29,1,0,0),DateTime.new(1987,9,27,1,0,0),7200,3600,:'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1987,9,27,1,0,0),DateTime.new(1988,3,27,1,0,0),7200,0,:'EET'))
add_period(TimezonePeriod.new(DateTime.new(1988,3,27,1,0,0),DateTime.new(1988,9,25,1,0,0),7200,3600,:'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1988,9,25,1,0,0),DateTime.new(1989,3,26,1,0,0),7200,0,:'EET'))
add_period(TimezonePeriod.new(DateTime.new(1989,3,26,1,0,0),DateTime.new(1989,9,24,1,0,0),7200,3600,:'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1989,9,24,1,0,0),DateTime.new(1990,3,25,1,0,0),7200,0,:'EET'))
add_period(TimezonePeriod.new(DateTime.new(1990,3,25,1,0,0),DateTime.new(1990,9,30,1,0,0),7200,3600,:'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1990,9,30,1,0,0),DateTime.new(1991,3,31,1,0,0),7200,0,:'EET'))
...
add_period(TimezonePeriod.new(DateTime.new(2045,3,26,1,0,0),DateTime.new(2045,9,3,22,29,42),7200,3600,:'EEST'))
end
end
end
end
