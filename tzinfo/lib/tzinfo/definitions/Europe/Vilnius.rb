...
add_period(TimezonePeriod.new(nil,DateTime.new(1879,12,31,22,18,44),6076,0,'LMT'))
add_period(TimezonePeriod.new(DateTime.new(1879,12,31,22,18,44),DateTime.new(1916,12,31,22,36,0),5040,0,'WMT'))
add_period(TimezonePeriod.new(DateTime.new(1916,12,31,22,36,0),DateTime.new(1919,10,9,22,24,24),5736,0,'KMT'))
add_period(TimezonePeriod.new(DateTime.new(1919,10,9,22,24,24),DateTime.new(1920,7,11,23,0,0),3600,0,'CET'))
add_period(TimezonePeriod.new(DateTime.new(1920,7,11,23,0,0),DateTime.new(1920,10,8,22,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1920,10,8,22,0,0),DateTime.new(1940,8,2,23,0,0),3600,0,'CET'))
add_period(TimezonePeriod.new(DateTime.new(1940,8,2,23,0,0),DateTime.new(1941,6,23,21,0,0),10800,0,'MSK'))
add_period(TimezonePeriod.new(DateTime.new(1941,6,23,21,0,0),DateTime.new(1943,3,29,1,0,0),3600,0,'CET'))
...
add_period(TimezonePeriod.new(DateTime.new(1944,4,3,1,0,0),DateTime.new(1944,7,31,22,0,0),3600,3600,'CEST'))
add_period(TimezonePeriod.new(DateTime.new(1944,7,31,22,0,0),DateTime.new(1981,9,30,20,0,0),10800,3600,'MSD'))
...
add_period(TimezonePeriod.new(DateTime.new(1997,10,26,0,0,0),DateTime.new(1997,12,31,22,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1997,12,31,22,0,0),DateTime.new(1998,3,29,1,0,0),7200,0,'EET'))
...
add_period(TimezonePeriod.new(DateTime.new(1999,10,31,1,0,0),DateTime.new(2002,12,31,22,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(2002,12,31,22,0,0),DateTime.new(2003,3,30,1,0,0),7200,0,'EET'))
...
add_period(TimezonePeriod.new(DateTime.new(2045,3,26,1,0,0),DateTime.new(2045,8,19,20,36,50),7200,3600,'EEST'))
end
@@instance = new
def self.instance
   @@instance
