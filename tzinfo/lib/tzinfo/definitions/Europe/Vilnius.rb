...
add_period(1944,7) {TimezonePeriod.new(DateTime.new0(Rational.new!(29175641,12),0,Date::ITALY),370728000,10800,3600,:'MSD')}
...
add_period(1997,10) {TimezonePeriod.new(877824000,883605600,7200,0,:'EET')}
add_period(1997,12) {TimezonePeriod.new(883605600,891133200,7200,0,:'EET')}
...
add_period(1999,10) {TimezonePeriod.new(941331600,1041372000,7200,0,:'EET')}
add_period(2002,12) {TimezonePeriod.new(1041372000,1048986000,7200,0,:'EET')}
