...
add_period(1941,6) {TimezonePeriod.new(DateTime.new0(Rational.new!(19441355,8),0,Date::ITALY),DateTime.new0(Rational.new!(58335973,24),0,Date::ITALY),3600,3600,:CEST)}
...
add_period(1997,10) {TimezonePeriod.new(877824000,891133200,7200,0,:EET)}
...
add_period(1999,10) {TimezonePeriod.new(941331600,1048986000,7200,0,:EET)}
