...
module Europe #:nodoc:
class Vilnius < Timezone #:nodoc:
setup
set_identifier('Europe/Vilnius')
add_unbounded_start_period {TimezonePeriod.new(nil,DateTime.new0(Rational.new!(52006653281,21600),0,Date::ITALY),6076,0,:'LMT')}
add_period(1879,12) {TimezonePeriod.new(DateTime.new0(Rational.new!(52006653281,21600),0,Date::ITALY),DateTime.new0(Rational.new!(290547533,120),0,Date::ITALY),5040,0,:'WMT')}
add_period(1916,12) {TimezonePeriod.new(DateTime.new0(Rational.new!(290547533,120),0,Date::ITALY),DateTime.new0(Rational.new!(8720069161,3600),0,Date::ITALY),5736,0,:'KMT')}
add_period(1919,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(8720069161,3600),0,Date::ITALY),DateTime.new0(Rational.new!(58140419,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1920,7) {TimezonePeriod.new(DateTime.new0(Rational.new!(58140419,24),0,Date::ITALY),DateTime.new0(Rational.new!(29071277,12),0,Date::ITALY),7200,0,:'EET')}
add_period(1920,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(29071277,12),0,Date::ITALY),DateTime.new0(Rational.new!(58316267,24),0,Date::ITALY),3600,0,:'CET')}
add_period(1940,8) {TimezonePeriod.new(DateTime.new0(Rational.new!(58316267,24),0,Date::ITALY),DateTime.new0(Rational.new!(19441355,8),0,Date::ITALY),10800,0,:'MSK')}
add_period(1941,6) {TimezonePeriod.new(DateTime.new0(Rational.new!(19441355,8),0,Date::ITALY),DateTime.new0(Rational.new!(58339501,24),0,Date::ITALY),3600,0,:'CET')}
...
add_period(1944,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(58348405,24),0,Date::ITALY),DateTime.new0(Rational.new!(29175641,12),0,Date::ITALY),3600,3600,:'CEST')}
add_period(1944,7) {TimezonePeriod.new(DateTime.new0(Rational.new!(29175641,12),0,Date::ITALY),DateTime.new0(Rational.new!(7334635,3),0,Date::ITALY),10800,3600,:'MSD')}
...
add_period(1997,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(4901495,2),0,Date::ITALY),DateTime.new0(Rational.new!(29409773,12),0,Date::ITALY),7200,0,:'EET')}
add_period(1997,12) {TimezonePeriod.new(DateTime.new0(Rational.new!(29409773,12),0,Date::ITALY),DateTime.new0(Rational.new!(58821637,24),0,Date::ITALY),7200,0,:'EET')}
...
add_period(1999,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(58835581,24),0,Date::ITALY),DateTime.new0(Rational.new!(29431685,12),0,Date::ITALY),7200,0,:'EET')}
add_period(2002,12) {TimezonePeriod.new(DateTime.new0(Rational.new!(29431685,12),0,Date::ITALY),DateTime.new0(Rational.new!(58865485,24),0,Date::ITALY),7200,0,:'EET')}
