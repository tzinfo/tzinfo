...
add_period(TimezonePeriod.new(nil,DateTime.new(1878,5,30,22,20,8),5992,0,'LMT'))
add_period(TimezonePeriod.new(DateTime.new(1878,5,30,22,20,8),DateTime.new(1921,4,30,22,20,8),5992,0,'HMT'))
add_period(TimezonePeriod.new(DateTime.new(1921,4,30,22,20,8),DateTime.new(1942,4,2,22,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1942,4,2,22,0,0),DateTime.new(1942,10,2,21,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1942,10,2,21,0,0),DateTime.new(1981,3,29,0,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1981,3,29,0,0,0),DateTime.new(1981,3,29,1,0,0),7200,0,'EET'))
...
add_period(TimezonePeriod.new(DateTime.new(2045,3,26,1,0,0),DateTime.new(2045,8,19,20,48,57),7200,3600,'EEST'))
end
@@instance = new
def self.instance
   @@instance
