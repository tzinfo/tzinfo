...
add_period(TimezonePeriod.new(nil,DateTime.new(1893,3,31,22,38,0),4920,0,'LMT'))
add_period(TimezonePeriod.new(DateTime.new(1893,3,31,22,38,0),DateTime.new(1916,4,30,22,0,0),3600,0,'CET'))
...
add_period(TimezonePeriod.new(DateTime.new(1944,10,2,1,0,0),DateTime.new(1944,12,31,23,0,0),3600,0,'CET'))
add_period(TimezonePeriod.new(DateTime.new(1944,12,31,23,0,0),DateTime.new(1945,4,28,22,0,0),7200,0,'CET'))
add_period(TimezonePeriod.new(DateTime.new(1945,4,28,22,0,0),DateTime.new(1945,10,31,21,0,0),7200,3600,'CEST'))
add_period(TimezonePeriod.new(DateTime.new(1945,10,31,21,0,0),DateTime.new(1945,12,31,22,0,0),7200,0,'CET'))
add_period(TimezonePeriod.new(DateTime.new(1945,12,31,22,0,0),DateTime.new(1981,3,31,21,0,0),10800,0,'MSK'))
...
add_period(TimezonePeriod.new(DateTime.new(1991,9,29,0,0,0),DateTime.new(1992,3,28,21,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1992,3,28,21,0,0),DateTime.new(1992,9,26,20,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1992,9,26,20,0,0),DateTime.new(1993,3,28,0,0,0),7200,0,'EET'))
...
add_period(TimezonePeriod.new(DateTime.new(2045,3,26,0,0,0),DateTime.new(2045,8,19,20,39,22),7200,3600,'EEST'))
end
@@instance = new
def self.instance
   @@instance
