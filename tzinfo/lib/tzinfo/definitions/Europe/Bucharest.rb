...
add_period(TimezonePeriod.new(nil,DateTime.new(1891,9,30,22,15,36),6264,0,'LMT'))
add_period(TimezonePeriod.new(DateTime.new(1891,9,30,22,15,36),DateTime.new(1931,7,23,22,15,36),6264,0,'BMT'))
add_period(TimezonePeriod.new(DateTime.new(1931,7,23,22,15,36),DateTime.new(1932,5,20,22,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1932,5,20,22,0,0),DateTime.new(1932,10,1,22,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1932,10,1,22,0,0),DateTime.new(1933,4,1,22,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1933,4,1,22,0,0),DateTime.new(1933,9,30,22,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1933,9,30,22,0,0),DateTime.new(1934,4,7,22,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1934,4,7,22,0,0),DateTime.new(1934,10,6,22,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1934,10,6,22,0,0),DateTime.new(1935,4,6,22,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1935,4,6,22,0,0),DateTime.new(1935,10,5,22,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1935,10,5,22,0,0),DateTime.new(1936,4,4,22,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1936,4,4,22,0,0),DateTime.new(1936,10,3,22,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1936,10,3,22,0,0),DateTime.new(1937,4,3,22,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1937,4,3,22,0,0),DateTime.new(1937,10,2,22,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1937,10,2,22,0,0),DateTime.new(1938,4,2,22,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1938,4,2,22,0,0),DateTime.new(1938,10,1,22,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1938,10,1,22,0,0),DateTime.new(1939,4,1,22,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1939,4,1,22,0,0),DateTime.new(1939,9,30,22,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1939,9,30,22,0,0),DateTime.new(1979,5,26,22,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1979,5,26,22,0,0),DateTime.new(1979,9,29,21,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1979,9,29,21,0,0),DateTime.new(1980,4,5,21,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1980,4,5,21,0,0),DateTime.new(1980,9,27,22,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1980,9,27,22,0,0),DateTime.new(1981,3,29,0,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1981,3,29,0,0,0),DateTime.new(1981,9,27,0,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1981,9,27,0,0,0),DateTime.new(1982,3,28,0,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1982,3,28,0,0,0),DateTime.new(1982,9,26,0,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1982,9,26,0,0,0),DateTime.new(1983,3,27,0,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1983,3,27,0,0,0),DateTime.new(1983,9,25,0,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1983,9,25,0,0,0),DateTime.new(1984,3,25,0,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1984,3,25,0,0,0),DateTime.new(1984,9,30,0,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1984,9,30,0,0,0),DateTime.new(1985,3,31,0,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1985,3,31,0,0,0),DateTime.new(1985,9,29,0,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1985,9,29,0,0,0),DateTime.new(1986,3,30,0,0,0),7200,0,'EET'))
...
add_period(TimezonePeriod.new(DateTime.new(1990,12,31,22,0,0),DateTime.new(1991,3,30,22,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1991,3,30,22,0,0),DateTime.new(1991,9,28,22,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1991,9,28,22,0,0),DateTime.new(1992,3,28,22,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1992,3,28,22,0,0),DateTime.new(1992,9,26,22,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1992,9,26,22,0,0),DateTime.new(1993,3,27,22,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1993,3,27,22,0,0),DateTime.new(1993,9,25,22,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1993,9,25,22,0,0),DateTime.new(1993,12,31,22,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1993,12,31,22,0,0),DateTime.new(1994,3,26,22,0,0),7200,0,'EET'))
...
add_period(TimezonePeriod.new(DateTime.new(1996,3,30,22,0,0),DateTime.new(1996,10,26,21,0,0),7200,3600,'EEST'))
add_period(TimezonePeriod.new(DateTime.new(1996,10,26,21,0,0),DateTime.new(1996,12,31,22,0,0),7200,0,'EET'))
add_period(TimezonePeriod.new(DateTime.new(1996,12,31,22,0,0),DateTime.new(1997,3,30,1,0,0),7200,0,'EET'))
...
add_period(TimezonePeriod.new(DateTime.new(2045,3,26,1,0,0),DateTime.new(2045,8,19,20,51,23),7200,3600,'EEST'))
end
@@instance = new
def self.instance
   @@instance
