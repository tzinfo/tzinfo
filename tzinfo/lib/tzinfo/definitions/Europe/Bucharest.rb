...
module Europe #:nodoc:
class Bucharest < Timezone #:nodoc:
setup
set_identifier('Europe/Bucharest')
add_unbounded_start_period {TimezonePeriod.new(nil,DateTime.new0(Rational.new!(964802571,400),0,Date::ITALY),6264,0,:'LMT')}
add_period(1891,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(964802571,400),0,Date::ITALY),DateTime.new0(Rational.new!(970618571,400),0,Date::ITALY),6264,0,:'BMT')}
add_period(1931,7) {TimezonePeriod.new(DateTime.new0(Rational.new!(970618571,400),0,Date::ITALY),DateTime.new0(Rational.new!(29122181,12),0,Date::ITALY),7200,0,:'EET')}
add_period(1932,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(29122181,12),0,Date::ITALY),DateTime.new0(Rational.new!(29123789,12),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1932,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(29123789,12),0,Date::ITALY),DateTime.new0(Rational.new!(29125973,12),0,Date::ITALY),7200,0,:'EET')}
add_period(1933,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(29125973,12),0,Date::ITALY),DateTime.new0(Rational.new!(29128157,12),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1933,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(29128157,12),0,Date::ITALY),DateTime.new0(Rational.new!(29130425,12),0,Date::ITALY),7200,0,:'EET')}
add_period(1934,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(29130425,12),0,Date::ITALY),DateTime.new0(Rational.new!(29132609,12),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1934,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(29132609,12),0,Date::ITALY),DateTime.new0(Rational.new!(29134793,12),0,Date::ITALY),7200,0,:'EET')}
add_period(1935,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(29134793,12),0,Date::ITALY),DateTime.new0(Rational.new!(29136977,12),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1935,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(29136977,12),0,Date::ITALY),DateTime.new0(Rational.new!(29139161,12),0,Date::ITALY),7200,0,:'EET')}
add_period(1936,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(29139161,12),0,Date::ITALY),DateTime.new0(Rational.new!(29141345,12),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1936,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(29141345,12),0,Date::ITALY),DateTime.new0(Rational.new!(29143529,12),0,Date::ITALY),7200,0,:'EET')}
add_period(1937,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(29143529,12),0,Date::ITALY),DateTime.new0(Rational.new!(29145713,12),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1937,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(29145713,12),0,Date::ITALY),DateTime.new0(Rational.new!(29147897,12),0,Date::ITALY),7200,0,:'EET')}
add_period(1938,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(29147897,12),0,Date::ITALY),DateTime.new0(Rational.new!(29150081,12),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1938,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(29150081,12),0,Date::ITALY),DateTime.new0(Rational.new!(29152265,12),0,Date::ITALY),7200,0,:'EET')}
add_period(1939,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(29152265,12),0,Date::ITALY),DateTime.new0(Rational.new!(29154449,12),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1939,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(29154449,12),0,Date::ITALY),DateTime.new0(Rational.new!(29328245,12),0,Date::ITALY),7200,0,:'EET')}
add_period(1979,5) {TimezonePeriod.new(DateTime.new0(Rational.new!(29328245,12),0,Date::ITALY),DateTime.new0(Rational.new!(19553171,8),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1979,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(19553171,8),0,Date::ITALY),DateTime.new0(Rational.new!(19554683,8),0,Date::ITALY),7200,0,:'EET')}
add_period(1980,4) {TimezonePeriod.new(DateTime.new0(Rational.new!(19554683,8),0,Date::ITALY),DateTime.new0(Rational.new!(29334125,12),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1980,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(29334125,12),0,Date::ITALY),DateTime.new0(Rational.new!(4889385,2),0,Date::ITALY),7200,0,:'EET')}
add_period(1981,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(4889385,2),0,Date::ITALY),DateTime.new0(Rational.new!(4889749,2),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1981,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(4889749,2),0,Date::ITALY),DateTime.new0(Rational.new!(4890113,2),0,Date::ITALY),7200,0,:'EET')}
add_period(1982,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(4890113,2),0,Date::ITALY),DateTime.new0(Rational.new!(4890477,2),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1982,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(4890477,2),0,Date::ITALY),DateTime.new0(Rational.new!(4890841,2),0,Date::ITALY),7200,0,:'EET')}
add_period(1983,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(4890841,2),0,Date::ITALY),DateTime.new0(Rational.new!(4891205,2),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1983,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(4891205,2),0,Date::ITALY),DateTime.new0(Rational.new!(4891569,2),0,Date::ITALY),7200,0,:'EET')}
add_period(1984,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(4891569,2),0,Date::ITALY),DateTime.new0(Rational.new!(4891947,2),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1984,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(4891947,2),0,Date::ITALY),DateTime.new0(Rational.new!(4892311,2),0,Date::ITALY),7200,0,:'EET')}
add_period(1985,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(4892311,2),0,Date::ITALY),DateTime.new0(Rational.new!(4892675,2),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1985,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(4892675,2),0,Date::ITALY),DateTime.new0(Rational.new!(4893039,2),0,Date::ITALY),7200,0,:'EET')}
...
add_period(1990,12) {TimezonePeriod.new(DateTime.new0(Rational.new!(29379089,12),0,Date::ITALY),DateTime.new0(Rational.new!(29380157,12),0,Date::ITALY),7200,0,:'EET')}
add_period(1991,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(29380157,12),0,Date::ITALY),DateTime.new0(Rational.new!(29382341,12),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1991,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(29382341,12),0,Date::ITALY),DateTime.new0(Rational.new!(29384525,12),0,Date::ITALY),7200,0,:'EET')}
...
add_period(1992,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(29386709,12),0,Date::ITALY),DateTime.new0(Rational.new!(29388893,12),0,Date::ITALY),7200,0,:'EET')}
add_period(1993,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(29388893,12),0,Date::ITALY),DateTime.new0(Rational.new!(29391077,12),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1993,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(29391077,12),0,Date::ITALY),DateTime.new0(Rational.new!(29392241,12),0,Date::ITALY),7200,0,:'EET')}
add_period(1993,12) {TimezonePeriod.new(DateTime.new0(Rational.new!(29392241,12),0,Date::ITALY),DateTime.new0(Rational.new!(29393261,12),0,Date::ITALY),7200,0,:'EET')}
...
add_period(1996,3) {TimezonePeriod.new(DateTime.new0(Rational.new!(29402081,12),0,Date::ITALY),DateTime.new0(Rational.new!(19603067,8),0,Date::ITALY),7200,3600,:'EEST')}
add_period(1996,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(19603067,8),0,Date::ITALY),DateTime.new0(Rational.new!(29405393,12),0,Date::ITALY),7200,0,:'EET')}
add_period(1996,12) {TimezonePeriod.new(DateTime.new0(Rational.new!(29405393,12),0,Date::ITALY),DateTime.new0(Rational.new!(58812901,24),0,Date::ITALY),7200,0,:'EET')}
