...
add_period(1939,9) {TimezonePeriod.new(DateTime.new0(Rational.new!(29154449,12),0,Date::ITALY),296604000,7200,0,:'EET')}
add_period(1979,5) {TimezonePeriod.new(296604000,307486800,7200,3600,:'EEST')}
add_period(1979,9) {TimezonePeriod.new(307486800,323816400,7200,0,:'EET')}
add_period(1980,4) {TimezonePeriod.new(323816400,338940000,7200,3600,:'EEST')}
add_period(1980,9) {TimezonePeriod.new(338940000,354672000,7200,0,:'EET')}
add_period(1981,3) {TimezonePeriod.new(354672000,370396800,7200,3600,:'EEST')}
add_period(1981,9) {TimezonePeriod.new(370396800,386121600,7200,0,:'EET')}
add_period(1982,3) {TimezonePeriod.new(386121600,401846400,7200,3600,:'EEST')}
...
add_period(1990,9) {TimezonePeriod.new(654652800,670370400,7200,0,:'EET')}
add_period(1991,3) {TimezonePeriod.new(670370400,686095200,7200,3600,:'EEST')}
add_period(1991,9) {TimezonePeriod.new(686095200,701820000,7200,0,:'EET')}
add_period(1992,3) {TimezonePeriod.new(701820000,717544800,7200,3600,:'EEST')}
add_period(1992,9) {TimezonePeriod.new(717544800,733269600,7200,0,:'EET')}
add_period(1993,3) {TimezonePeriod.new(733269600,748994400,7200,3600,:'EEST')}
add_period(1993,9) {TimezonePeriod.new(748994400,764719200,7200,0,:'EET')}
