...
add_period(1945,10) {TimezonePeriod.new(DateTime.new0(Rational.new!(58361845,24),0,Date::ITALY),186120000,-7200,0,:CVT)}
add_period(1975,11) {TimezonePeriod.new(186120000,nil,-3600,0,:CVT)}
end
end
end
end
