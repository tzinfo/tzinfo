...
add_period(1908,1) {TimezonePeriod.new(DateTime.new0(Rational.new!(26113876403,10800),0,Date::ITALY),347155200,0,0,:'WET')}
add_period(1981,1) {TimezonePeriod.new(347155200,354675600,0,0,:'WET')}
