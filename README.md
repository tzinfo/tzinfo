...
period.utc_offset               # => -18000
period.std_offset               # => 3600
period.utc_total_offset         # => -14400
...
transitions.map do |t|
  [t.local_end_at.to_time, t.offset.utc_total_offset, t.offset.abbreviation]
end
...
offsets.map {|o| [o.utc_total_offset, o.abbreviation] }
# => [[-17762, "LMT"],
#     [-18000, "EST"],
#     [-14400, "EDT"],
#     [-14400, "EWT"],
