    ...
    module Indexes
      module Countries
        ...
        country_index do |i|
          ...
          i.timezone :t3, 'Africa/Khartoum', 78, 5, 488, 15
          i.timezone :t4, 'Africa/Lagos', 129, 20, 17, 5, 'West Africa Time (UTC+1)'
          i.timezone :t5, 'Africa/Maputo', -779, 30, 391, 12, 'Central Africa Time (UTC+2)'
          i.timezone :t6, 'Africa/Nairobi', -77, 60, 2209, 60
          i.timezone :t7, 'America/Curacao', 731, 60, -69, 1
          i.timezone :t8, 'America/Panama', 269, 30, -1193, 15
          i.timezone :t9, 'America/Port_of_Spain', 213, 20, -3691, 60
          i.timezone :t10, 'Asia/Bangkok', 55, 4, 6031, 60
          i.timezone :t11, 'Asia/Dubai', 253, 10, 553, 10
          i.timezone :t12, 'Asia/Qatar', 1517, 60, 773, 15
          i.timezone :t13, 'Asia/Riyadh', 739, 30, 2803, 60
          i.timezone :t14, 'Europe/Belgrade', 269, 6, 41, 2
          i.timezone :t15, 'Europe/Helsinki', 361, 6, 749, 30
          i.timezone :t16, 'Europe/London', 6181, 120, -451, 3600
          i.timezone :t17, 'Europe/Oslo', 719, 12, 43, 4
          i.timezone :t18, 'Europe/Prague', 601, 12, 433, 30
          i.timezone :t19, 'Europe/Rome', 419, 10, 749, 60
          i.timezone :t20, 'Europe/Zurich', 2843, 60, 128, 15, 'Swiss time'
          i.timezone :t21, 'Indian/Reunion', -313, 15, 832, 15, 'Réunion, Crozet Is, Scattered Is'
          i.timezone :t22, 'Pacific/Auckland', -553, 15, 5243, 30, 'New Zealand time'
          i.timezone :t23, 'Pacific/Guam', 202, 15, 579, 4
          i.timezone :t24, 'Pacific/Honolulu', 15341, 720, -18943, 120, 'Hawaii time'
          i.timezone :t25, 'Pacific/Pago_Pago', -214, 15, -1707, 10, 'Samoa, Midway'
          ...
          i.country 'AX', 'Aaland Islands' do |c|
            c.timezone :t15
          end
          ...
          i.country 'BQ', 'Caribbean Netherlands' do |c|
            c.timezone :t7
          end
          ...
          i.country 'CI', 'Cote d\'Ivoire' do |c|
            c.timezone :t1
          end
          ...
          i.country 'MF', 'St Martin (French part)' do |c|
            c.timezone :t9
          end
          ...
          i.country 'SX', 'St Maarten (Dutch part)' do |c|
            c.timezone :t7
          end
          ...
          i.country 'TF', 'French Southern & Antarctic Lands' do |c|
