      ...
      module Europe
        module London
          ...
          timezone 'Europe/London' do |tz|
            ...
            tz.transition :o2, 3194816400
            tz.transition :o1, 3212960400
            tz.transition :o2, 3226266000
            tz.transition :o1, 3245014800
            tz.transition :o2, 3257715600
            tz.transition :o1, 3276464400
          end
        end
      end
    end
